...
void MushroomStewItem::registerRecipes(recipe::CraftingRecipeManager& recipeManager)
{
    recipeManager.addShapedRecipe(ItemStack(Item::byRawId(26)),
        {std::string("Y"), std::string("X"), std::string("#"), 'X', Block::BROWN_MUSHROOM, 'Y', Block::RED_MUSHROOM, '#', Item::byRawId(25)});
    recipeManager.addShapedRecipe(ItemStack(Item::byRawId(26)),
        {std::string("Y"), std::string("X"), std::string("#"), 'X', Block::RED_MUSHROOM, 'Y', Block::BROWN_MUSHROOM, '#', Item::byRawId(25)});
}
