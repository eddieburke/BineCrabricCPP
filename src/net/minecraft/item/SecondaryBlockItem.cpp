...
void SecondaryBlockItem::registerRecipes(recipe::CraftingRecipeManager& recipeManager)
{
    recipeManager.addShapedRecipe(ItemStack(Item::byRawId(98)),
        {std::string("AAA"), std::string("BEB"), std::string("CCC"),
            'A', Item::byRawId(79), 'B', Item::byRawId(97), 'C', Item::byRawId(40), 'E', Item::byRawId(88)});
    recipeManager.addShapedRecipe(ItemStack(Item::byRawId(100)),
        {std::string("#X#"), std::string("III"), '#', Block::LIT_REDSTONE_TORCH, 'X', Item::byRawId(75), 'I', Block::STONE});
}
