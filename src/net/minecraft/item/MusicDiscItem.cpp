...
MusicDiscItem::MusicDiscItem(int rawId, std::string soundIn)
    : Item(rawId),
      sound(std::move(soundIn))
{
    setMaxCount(1);
}

bool MusicDiscItem::useOnBlock(ItemStack* stack, PlayerEntity* /*user*/, World* world, int x, int y, int z, int /*side*/)
{
