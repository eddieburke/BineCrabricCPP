...
protected:
    ...
    {
        if (block == Block::COBBLESTONE || block == Block::DOUBLE_SLAB || block == Block::SLAB || block == Block::STONE
            || block == Block::SANDSTONE || block == Block::MOSSY_COBBLESTONE || block == Block::IRON_ORE
            || block == Block::IRON_BLOCK || block == Block::COAL_ORE || block == Block::GOLD_BLOCK || block == Block::GOLD_ORE
            || block == Block::DIAMOND_ORE || block == Block::DIAMOND_BLOCK || block == Block::ICE || block == Block::NETHERRACK
    ...
    [[nodiscard]] bool isSuitableFor(Block* block) const override
    {
        ...
        if (block == Block::IRON_BLOCK || block == Block::IRON_ORE || block == Block::LAPIS_BLOCK || block == Block::LAPIS_ORE) {
            return toolMaterialMiningLevel(toolMaterial_) >= 1;
        }
        return &block->material == &block::material::Material::STONE || &block->material == &block::material::Material::METAL;
    }
};
