...
public:
  ...
  static constexpr std::array<const char*, 16> names{"black", "red", "green", "brown", "blue", "purple",
                                                     "cyan", "silver", "gray", "pink", "lime", "yellow",
                                                     "lightBlue", "magenta", "orange", "white"};
  static constexpr std::array<int, 16> colors{0x1E1B1B, 11743532, 3887386, 5320730, 2437522, 8073150,
                                              2651799, 2651799, 0x434343, 14188952, 4312372, 14602026,
