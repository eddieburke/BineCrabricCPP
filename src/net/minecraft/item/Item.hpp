...
class Item {
 ...
 virtual bool postMine(
     ItemStack* /*stack*/, int /*blockId*/, int /*x*/, int /*y*/, int /*z*/, LivingEntity* /*miner*/) {
  return false;
 }
 virtual void useOnEntity(ItemStack* /*stack*/, LivingEntity* /*entity*/) {
 }
 virtual void inventoryTick(
     ItemStack* /*stack*/, World* /*world*/, Entity* /*entity*/, int /*slot*/, bool /*selected*/) {
 }
