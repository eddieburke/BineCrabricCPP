...
IronSwordItem::IronSwordItem() : SwordItem(11, ToolMaterial::Iron) {}
...
{
    recipeManager.addShapedRecipe(ItemStack(Item::byRawId(11)),
        {std::string("X"), std::string("X"), std::string("#"), '#', Item::byRawId(24), 'X', Item::byRawId(9)});
}

static registry::RegisterItem<IronSwordItem> s_itemReg(11);
} // namespace net::minecraft::item
