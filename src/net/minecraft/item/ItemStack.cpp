...
int ItemStack::maxCount() const { return getMaxCount(); }
...
bool ItemStack::isDamageable() const { return getMaxDamage() > 0; }
bool ItemStack::isDamaged() const { return isDamageable() && damage > 0; }
