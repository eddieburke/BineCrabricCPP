...
public:
  ...
  [[nodiscard]] bool isLuaModGenerationEnabled() const noexcept { return luaModGenerationEnabled_; }
  void setLuaModGenerationEnabled(bool value) noexcept { luaModGenerationEnabled_ = value; }
