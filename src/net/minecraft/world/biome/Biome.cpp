...
struct BiomeBootstrap {
    static void registerClass() { Biome::init(); }
};
...
Biome& Biome::rainforest() { init(); return gRainforest; }
Biome& Biome::swampland() { init(); return gSwampland; }
Biome& Biome::seasonalForest() { init(); return gSeasonalForest; }
Biome& Biome::forest() { init(); return gForest; }
Biome& Biome::savanna() { init(); return gSavanna; }
Biome& Biome::shrubland() { init(); return gShrubland; }
Biome& Biome::taiga() { init(); return gTaiga; }
Biome& Biome::desert() { init(); return gDesert; }
Biome& Biome::plains() { init(); return gPlains; }
Biome& Biome::iceDesert() { init(); return gIceDesert; }
Biome& Biome::tundra() { init(); return gTundra; }
Biome& Biome::hell() { init(); return gHell; }
Biome& Biome::sky() { init(); return gSky; }
