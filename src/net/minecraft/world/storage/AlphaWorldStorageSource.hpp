...
public:
    ...
    [[nodiscard]] std::string getName() const override { return "Old Format"; }
    ...
    [[nodiscard]] bool needsConversion(const std::string&) const override { return false; }
    bool convert(const std::string&, client::gui::screen::LoadingDisplay*) override { return false; }

protected:
    [[nodiscard]] const fs::path& savesDirectory() const noexcept { return dir_; }
