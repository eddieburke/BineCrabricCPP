...
public:
    [[nodiscard]] std::optional<WorldProperties> loadProperties() override { return std::nullopt; }
    ...
    void save(const WorldProperties& properties) override { (void)properties; }
    [[nodiscard]] PlayerSaveHandler* getPlayerSaveHandler() override { return nullptr; }
