...
public:
  OverworldChunkGenerator(World* world, std::uint64_t seed)
      : world_(world), seed_(seed), random_(seed), constructionRandom_(seed),
        minLimitPerlinNoise_(constructionRandom_, 16), maxLimitPerlinNoise_(constructionRandom_, 16),
        perlinNoise1_(constructionRandom_, 8), perlinNoise2_(constructionRandom_, 4),
        perlinNoise3_(constructionRandom_, 4), floatingIslandScale_(constructionRandom_, 10),
        floatingIslandNoise_(constructionRandom_, 16), forestNoise_(constructionRandom_, 8), biomeSource_(seed) {
  }
