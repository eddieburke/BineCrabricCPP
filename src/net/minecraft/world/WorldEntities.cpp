...
bool World::spawnEntity(Entity* entity) {
 ...
 if(isPlayer) {
  auto* player = static_cast<PlayerEntity*>(entity);
...
void World::notifyEntityAdded(Entity* entity) {
 ...
 if(entity != nullptr &&
    net::minecraft::mod::runtime::hasLuaHook(net::minecraft::mod::runtime::LuaEventId::EntitySpawn)) {
...
void World::notifyEntityRemoved(Entity* entity) {
 ...
 if(entity != nullptr &&
    net::minecraft::mod::runtime::hasLuaHook(net::minecraft::mod::runtime::LuaEventId::EntityRemove)) {
