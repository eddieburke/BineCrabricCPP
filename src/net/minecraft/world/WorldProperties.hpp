...
public:
  ...
  WorldProperties(std::uint64_t seed, std::string name)
      : seed_(seed), name_(std::move(name)) {
  }
  ...
  [[nodiscard]] std::uint64_t getSeed() const noexcept { return seed_; }
  [[nodiscard]] int getSpawnX() const noexcept { return spawnX_; }
  [[nodiscard]] int getSpawnY() const noexcept { return spawnY_; }
  [[nodiscard]] int getSpawnZ() const noexcept { return spawnZ_; }
  [[nodiscard]] std::uint64_t getTime() const noexcept { return time_; }
  [[nodiscard]] std::uint64_t getLastPlayed() const noexcept { return lastPlayed_; }
  [[nodiscard]] std::uint64_t getSizeOnDisk() const noexcept { return sizeOnDisk_; }
  [[nodiscard]] int getDimensionId() const noexcept { return dimensionId_; }
  [[nodiscard]] const std::string& getName() const noexcept { return name_; }
  [[nodiscard]] int getVersion() const noexcept { return version_; }
  [[nodiscard]] bool getThundering() const noexcept { return thundering_; }
  [[nodiscard]] int getThunderTime() const noexcept { return thunderTime_; }
  [[nodiscard]] bool getRaining() const noexcept { return raining_; }
  [[nodiscard]] int getRainTime() const noexcept { return rainTime_; }
  ...
  void setTime(std::uint64_t time) noexcept { time_ = time; }
  void setSizeOnDisk(std::uint64_t size) noexcept { sizeOnDisk_ = size; }
  void setName(std::string name) { name_ = std::move(name); }
  void setVersion(int version) noexcept { version_ = version; }
  void setThundering(bool value) noexcept { thundering_ = value; }
  void setThunderTime(int time) noexcept { thunderTime_ = time; }
  void setRaining(bool value) noexcept { raining_ = value; }
  void setRainTime(int time) noexcept { rainTime_ = time; }
  ...
  void clearPlayerNbt() noexcept { playerNbt_.reset(); }
  ...
  [[nodiscard]] std::uint64_t setLastPlayed() noexcept { return touchLastPlayed(); }
