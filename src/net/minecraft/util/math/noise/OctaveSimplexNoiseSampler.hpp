...
public:
  ...
  std::vector<double>& sample(std::vector<double>& map, double x, double z, int width, int depth, double frequencyX,
                              double frequencyZ, double persistence, double lacunarity = 0.5) const {
    frequencyX /= 1.5;
    frequencyZ /= 1.5;
