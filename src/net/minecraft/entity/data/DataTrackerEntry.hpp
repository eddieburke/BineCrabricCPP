...
using DataTrackerByteArray = std::vector<std::uint8_t>;
using DataTrackerValue =
    std::variant<std::int8_t, std::int16_t, std::int32_t, float, std::string, ItemStack, Vec3i, DataTrackerByteArray>;
