...
public:
    ...
    [[nodiscard]] std::optional<Box> getBoundingBox() const override { return std::nullopt; }
    ...
    std::size_t size() const override { return 27; }
    ...
    [[nodiscard]] std::string getName() const override { return "Minecart"; }
    [[nodiscard]] int getMaxCountPerStack() const override { return 64; }
    ...
    [[nodiscard]] std::optional<Vec3d> snapPositionToRailWithOffset(double xIn, double yIn, double zIn, double offset) const;
