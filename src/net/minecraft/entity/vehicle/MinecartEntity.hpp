...
public:
  ...
  void setPositionAndAnglesAvoidEntities(double x, double y, double z, float yaw, float pitch,
                                         int interpolationSteps) override;
  ...
  [[nodiscard]] std::optional<Vec3d> snapPositionToRailWithOffset(double xIn, double yIn, double zIn,
                                                                  double offset) const;
