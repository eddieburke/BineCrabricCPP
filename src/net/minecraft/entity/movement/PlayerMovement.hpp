...
public:
    enum class Medium { Water, Lava, Ground, Flying };

    static void travel(LivingEntity& entity, float sideways, float forward);
    static void travelFlying(LivingEntity& entity, float sideways, float forward);
