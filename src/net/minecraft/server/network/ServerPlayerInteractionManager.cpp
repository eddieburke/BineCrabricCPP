...
bool ServerPlayerInteractionManager::interactItem(::net::minecraft::entity::player::PlayerEntity* playerIn, World* worldIn,
                                                  ItemStack* stack) {
...
bool ServerPlayerInteractionManager::interactBlock(::net::minecraft::entity::player::PlayerEntity* playerIn, World* worldIn,
