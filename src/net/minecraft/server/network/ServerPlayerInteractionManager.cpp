...
bool ServerPlayerInteractionManager::interactItem(entity::player::PlayerEntity* playerIn, World* worldIn, ItemStack* stack)
{
...
bool ServerPlayerInteractionManager::interactBlock(
    entity::player::PlayerEntity* playerIn, World* worldIn, ItemStack* stack, int x, int y, int z, int side)
{
