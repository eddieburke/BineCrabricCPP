...
public:
    ...
    bool interactItem(entity::player::PlayerEntity* player, World* world, ItemStack* stack);
    bool interactBlock(entity::player::PlayerEntity* player, World* world, ItemStack* stack, int x, int y, int z, int side);
