...
HWND PlayerStatsGui::create(HWND parent, HINSTANCE instance, int x, int y, int width, int height) {
  ...
  hwnd_ = CreateWindowExW(0, windowClass.className().c_str(), L"", WS_CHILD | WS_VISIBLE, x, y, width, height, parent,
...
void PlayerStatsGui::paint(HDC hdc) const {
  ...
  auto font = makeUniqueHfont(CreateFontW(16, 0, 0, 0, FW_NORMAL, FALSE, FALSE, FALSE, DEFAULT_CHARSET, OUT_DEFAULT_PRECIS,
