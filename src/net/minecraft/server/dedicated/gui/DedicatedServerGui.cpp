...
bool DedicatedServerGui::createWindow() {
 ...
 frameHwnd_ = CreateWindowExW(0,
                              frameClass.className().c_str(),
                              L"Minecraft server",
...
LRESULT CALLBACK DedicatedServerGui::frameWindowProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam) {
 ...
 case WM_CREATE: {
  ...
  CreateWindowExW(0,
                  ...
                  WS_CHILD | WS_VISIBLE | BS_GROUPBOX,
                  kMargin,
                  statsY + kStatsChildHeight + 8,
                  kStatsPanelWidth,
                  kFrameHeight - (statsY + kStatsChildHeight + 8) - kMargin,
                  hwnd,
                  nullptr,
                  instance,
                  nullptr);
  ...
  gui->logEditHwnd_ = CreateWindowExW(
      WS_EX_CLIENTEDGE,
      L"EDIT",
      L"",
      ...
      logX + kGroupInset,
      logEditY,
      logWidth - kGroupInset * 2,
      logEditHeight,
      hwnd,
      nullptr,
      instance,
      nullptr);
  gui->commandEditHwnd_ = CreateWindowExW(WS_EX_CLIENTEDGE,
                                          L"EDIT",
                                          L"",
                                          WS_CHILD | WS_VISIBLE | ES_AUTOHSCROLL,
                                          logX + kGroupInset,
                                          logEditY + logEditHeight + 8,
                                          logWidth - kGroupInset * 2,
                                          commandHeight,
                                          hwnd,
                                          nullptr,
...
LRESULT CALLBACK DedicatedServerGui::commandEditProc(
