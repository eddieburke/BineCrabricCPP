...
private:
  using Storage = std::variant<std::monostate, std::int8_t, std::int16_t, std::int32_t, std::int64_t, float, double,
                               std::vector<std::uint8_t>, std::string, List, Compound, std::vector<std::int32_t>,
