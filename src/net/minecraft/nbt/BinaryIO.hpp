...
inline void readI32BEArray(const std::vector<std::uint8_t>& data, std::size_t& pos, std::int32_t* dest,
                           std::size_t count) {
...
inline void readI64BEArray(const std::vector<std::uint8_t>& data, std::size_t& pos, std::int64_t* dest,
                           std::size_t count) {
