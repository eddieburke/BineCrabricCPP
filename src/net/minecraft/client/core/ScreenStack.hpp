...
class ScreenStack {
public:
    explicit ScreenStack(ClientHost& host) noexcept;
    ...
    [[nodiscard]] gui::screen::Screen* current() const noexcept { return currentScreen_.get(); }
    [[nodiscard]] bool hasScreen() const noexcept { return currentScreen_ != nullptr; }
