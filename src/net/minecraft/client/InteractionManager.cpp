...
InteractionManager::InteractionManager(Minecraft* minecraft)
    : minecraft(minecraft)
{
}
...
bool InteractionManager::interactBlock(PlayerEntity* player, World* world, ItemStack* item, int x, int y, int z, int side)
{
