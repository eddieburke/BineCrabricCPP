...
void ModelPart::addCuboid(float x, float y, float z, int sizeX, int sizeY, int sizeZ, float dilation) {
 ...
 std::array<Quad, 6> newFaces{
     Quad(std::array<Vertex, 4>{vertex6, vertex2, vertex3, vertex7},
          textureU + sizeZ + sizeX,
          textureV + sizeZ,
          textureU + sizeZ + sizeX + sizeZ,
          textureV + sizeZ + sizeY),
     Quad(std::array<Vertex, 4>{vertex, vertex5, vertex8, vertex4},
          textureU + 0,
          textureV + sizeZ,
          textureU + sizeZ,
          textureV + sizeZ + sizeY),
     Quad(std::array<Vertex, 4>{vertex6, vertex5, vertex, vertex2},
          textureU + sizeZ,
          textureV + 0,
          textureU + sizeZ + sizeX,
          textureV + sizeZ),
     Quad(std::array<Vertex, 4>{vertex3, vertex4, vertex8, vertex7},
          textureU + sizeZ + sizeX,
          textureV + 0,
          textureU + sizeZ + sizeX + sizeX,
          textureV + sizeZ),
     Quad(std::array<Vertex, 4>{vertex2, vertex, vertex4, vertex3},
          textureU + sizeZ,
          textureV + sizeZ,
          textureU + sizeZ + sizeX,
          textureV + sizeZ + sizeY),
     Quad(std::array<Vertex, 4>{vertex5, vertex6, vertex7, vertex8},
          textureU + sizeZ + sizeX + sizeZ,
          textureV + sizeZ,
