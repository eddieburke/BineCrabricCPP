...
public:
        ...
        : Entity(world)
    {
        ...
        const float speed = MathHelper::sqrt(this->velocityX * this->velocityX + this->velocityY * this->velocityY + this->velocityZ * this->velocityZ);
    ...
    virtual void render(render::Tessellator& tessellator, float partialTicks, float horizontalSize,
        float verticalSize, float depthSize, float widthOffset, float heightOffset)
    {
    ...
    [[nodiscard]] virtual int getGroup() const { return 0; }
