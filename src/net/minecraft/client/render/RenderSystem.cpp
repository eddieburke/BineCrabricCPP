...
void RenderSystem::clearColor(float r, float g, float b, float a) {
 if(g_shadow.clearColor[0] != r || g_shadow.clearColor[1] != g || g_shadow.clearColor[2] != b ||
...
RenderSystem::ColorMaskScope::ColorMaskScope(bool r, bool g, bool b, bool a)
    : savedR_(g_shadow.colorMaskR),
      savedG_(g_shadow.colorMaskG),
      savedB_(g_shadow.colorMaskB),
      savedA_(g_shadow.colorMaskA) {
...
void RenderSystem::viewport(int x, int y, int width, int height) {
 if(!g_shadow.viewportValid || g_shadow.viewport[0] != x || g_shadow.viewport[1] != y ||
    g_shadow.viewport[2] != width || g_shadow.viewport[3] != height) {
