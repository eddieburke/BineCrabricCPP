...
void ArrowEntityRenderer::render(
 ...
 RenderSystem::rotate(arrow->prevYaw + (arrow->yaw - arrow->prevYaw) * tickDelta - 90.0f, 0.0f, 1.0f, 0.0f);
 RenderSystem::rotate(arrow->prevPitch + (arrow->pitch - arrow->prevPitch) * tickDelta, 0.0f, 0.0f, 1.0f);
 ...
 if(shake > 0.0f) {
  ...
  RenderSystem::rotate(shakeAngle, 0.0f, 0.0f, 1.0f);
 }
 RenderSystem::rotate(45.0f, 1.0f, 0.0f, 0.0f);
 RenderSystem::scale(scale, scale, scale);
 RenderSystem::translate(-4.0f, 0.0f, 0.0f);
