...
void MinecartEntityRenderer::render(
 ...
 matrices.rotate(180.0f - renderYaw, 0.0f, 1.0f, 0.0f);
 matrices.rotate(-renderPitch, 0.0f, 0.0f, 1.0f);
 ...
 if(cart->type != 0) {
  ...
  matrices.rotate(-90.0f, 0.0f, 1.0f, 0.0f);
  matrices.translate(0.0f, -0.3125f, 0.0f);
  matrices.scale(1.0f / cargoScale, 1.0f / cargoScale, 1.0f / cargoScale);
 }
