...
void MinecartEntityRenderer::render(
 ...
 }
 {
  ...
  RenderSystem::rotate(180.0f - renderYaw, 0.0f, 1.0f, 0.0f);
  RenderSystem::rotate(-renderPitch, 0.0f, 0.0f, 1.0f);
  ...
  if(cart->type != 0) {
   ...
   RenderSystem::scale(cargoScale, cargoScale, cargoScale);
   RenderSystem::translate(0.0f, 0.3125f, 0.0f);
   ...
   RenderSystem::rotate(-90.0f, 0.0f, 1.0f, 0.0f);
   RenderSystem::translate(0.0f, -0.3125f, 0.0f);
   RenderSystem::scale(1.0f / cargoScale, 1.0f / cargoScale, 1.0f / cargoScale);
  }
...
namespace {
static ::net::minecraft::registry::RegisterEntityRenderer<net::minecraft::entity::vehicle::MinecartEntity>
    autoRendererReg;
} // namespace
