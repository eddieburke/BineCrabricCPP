...
void EntityRenderer::postRender(const net::minecraft::Entity& entity, double x, double y, double z, float /*yaw*/,
                                float tickDelta) {
...
void EntityRenderer::renderOnFire(const net::minecraft::Entity& entity, double dx, double dy, double dz,
                                  float tickDelta) {
  (void)tickDelta;
