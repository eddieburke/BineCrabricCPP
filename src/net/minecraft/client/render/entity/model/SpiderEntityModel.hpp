...
public:
    ...
    void setAngles(float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch, float scale) override
    {
        ...
        const float hindLegYawSwing = -(net::minecraft::util::math::MathHelper::cos(limbAngle * 0.6662f * 2.0f + 0.0f) * 0.4f) * limbDistance;
        const float middleHindLegYawSwing = -(net::minecraft::util::math::MathHelper::cos(limbAngle * 0.6662f * 2.0f + kPi) * 0.4f) * limbDistance;
        const float middleFrontLegYawSwing = -(net::minecraft::util::math::MathHelper::cos(limbAngle * 0.6662f * 2.0f + 1.5707964f) * 0.4f) * limbDistance;
        const float frontLegYawSwing = -(net::minecraft::util::math::MathHelper::cos(limbAngle * 0.6662f * 2.0f + 4.712389f) * 0.4f) * limbDistance;
        const float hindLegRollSwing = net::minecraft::util::math::MathHelper::abs(net::minecraft::util::math::MathHelper::sin(limbAngle * 0.6662f + 0.0f) * 0.4f) * limbDistance;
        const float middleHindLegRollSwing = net::minecraft::util::math::MathHelper::abs(net::minecraft::util::math::MathHelper::sin(limbAngle * 0.6662f + kPi) * 0.4f) * limbDistance;
        const float middleFrontLegRollSwing = net::minecraft::util::math::MathHelper::abs(net::minecraft::util::math::MathHelper::sin(limbAngle * 0.6662f + 1.5707964f) * 0.4f) * limbDistance;
        const float frontLegRollSwing = net::minecraft::util::math::MathHelper::abs(net::minecraft::util::math::MathHelper::sin(limbAngle * 0.6662f + 4.712389f) * 0.4f) * limbDistance;
