...
void WolfEntityModel::render(float limbAngle, float limbDistance, float animationProgress, float headYaw,
...
void WolfEntityModel::animateModel(::net::minecraft::entity::LivingEntity& entity, float limbAngle, float limbDistance,
                                   float tickDelta) {
...
void WolfEntityModel::setAngles(float limbAngle, float limbDistance, float animationProgress, float headYaw,
                                float headPitch, float scale) {
