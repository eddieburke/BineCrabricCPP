...
public:
    ...
    SquidEntityModel()
    {
        ...
        for (std::size_t i = 0; i < tentacles.size(); ++i) {
            ...
            const double placementAngle = static_cast<double>(i) * 3.14159265358979323846 * 2.0 / static_cast<double>(tentacles.size());
            ...
            const double baseYaw = static_cast<double>(i) * 3.14159265358979323846 * -2.0 / static_cast<double>(tentacles.size()) + 1.5707963267948966;
