...
void PaintingEntityRenderer::render(const net::minecraft::Entity& entity, double x, double y, double z, float yaw, float tickDelta)
{
    (void)tickDelta;
...
void PaintingEntityRenderer::renderPainting(const ::net::minecraft::entity::decoration::painting::PaintingEntity& painting, int width,
...
void PaintingEntityRenderer::applyBrightness(const ::net::minecraft::entity::decoration::painting::PaintingEntity& painting, float u,
    float v)
{
