...
void SquidEntityRenderer::applyHandSwingRotation(const net::minecraft::LivingEntity& entity, float headBob,
  ...
  gl::translatef(0.0f, 0.5f, 0.0f);
  gl::rotatef(180.0f - bodyYaw, 0.0f, 1.0f, 0.0f);
  gl::rotatef(tilt, 1.0f, 0.0f, 0.0f);
  gl::rotatef(roll, 0.0f, 1.0f, 0.0f);
  gl::translatef(0.0f, -1.2f, 0.0f);
}
