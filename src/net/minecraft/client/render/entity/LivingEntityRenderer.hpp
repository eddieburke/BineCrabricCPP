...
class LivingEntityRenderer : public EntityRenderer {
 ...
 virtual void applyTranslation(const net::minecraft::LivingEntity& entity,
                               double x,
                               double y,
                               double z,
                               net::minecraft::util::math::MatrixStack& matrices);
 ...
 virtual void renderMore(const net::minecraft::LivingEntity& entity,
                         float tickDelta,
                         net::minecraft::util::math::MatrixStack& matrices,
 ...
 virtual void applyScale(const net::minecraft::LivingEntity& entity,
                         float tickDelta,
                         net::minecraft::util::math::MatrixStack& matrices);
 virtual void renderNameTag(const net::minecraft::LivingEntity& entity,
                            double x,
                            double y,
                            double z,
                            net::minecraft::util::math::MatrixStack& matrices,
