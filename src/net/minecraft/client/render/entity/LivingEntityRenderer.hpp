...
protected:
  ...
  virtual void applyHandSwingRotation(const net::minecraft::LivingEntity& entity, float headBob, float bodyYaw,
                                      float tickDelta);
  ...
  [[nodiscard]] virtual bool bindDecorationTexture(const net::minecraft::LivingEntity& entity, int layer,
                                                   float tickDelta);
  ...
  [[nodiscard]] virtual int getOverlayColor(const net::minecraft::LivingEntity& entity, float brightness,
  ...
  void renderNameTag(const net::minecraft::LivingEntity& entity, const std::string& name, double x, double y,
                     double z, int range);
};
} // namespace net::minecraft::client::render::entity
