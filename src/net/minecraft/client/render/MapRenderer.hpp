...
public:
    MapRenderer() = default;
    MapRenderer(font::TextRenderer* textRendererIn,
        net::minecraft::client::texture::TextureManager* textureManagerIn);

    void render(net::minecraft::PlayerEntity& player, net::minecraft::client::texture::TextureManager& textureManagerIn,
