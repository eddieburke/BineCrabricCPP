...
// Flat Pipeline/GlState names; bodies live in shaderpack:: during cutover.
...
using PackDefinition = shaderpack::ShaderPackDefinition;
using PackProgramSource = shaderpack::ShaderProgramSource;
using PackTarget = shaderpack::ShaderTarget;
using PackPass = shaderpack::ShaderPass;
using PackSetting = shaderpack::PackSetting;
using CustomImage = shaderpack::CustomImage;
using CustomTexture = shaderpack::CustomTexture;
using BufferBlend = shaderpack::BufferBlend;
using AlphaTestDirective = shaderpack::AlphaTestDirective;
using SettingType = shaderpack::SettingType;
using ProgramScale = shaderpack::ProgramScale;
} // namespace net::minecraft::client::render
