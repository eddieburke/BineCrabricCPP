...
void BlockFaceRenderer::renderEastFace(
  ...
  if(ctx_.faceState.useAo) {
    (*tessellator)
        .color(ctx_.faceState.colors.red[0], ctx_.faceState.colors.green[0], ctx_.faceState.colors.blue[0]);
    emitVertex(*tessellator, 0.0f, 0.0f, -1.0f, xMin, yMax, zCoord, uMin, vCornerA);
    (*tessellator)
        .color(ctx_.faceState.colors.red[1], ctx_.faceState.colors.green[1], ctx_.faceState.colors.blue[1]);
    emitVertex(*tessellator, 0.0f, 0.0f, -1.0f, xMax, yMax, zCoord, uMax, vMax);
    (*tessellator)
        .color(ctx_.faceState.colors.red[2], ctx_.faceState.colors.green[2], ctx_.faceState.colors.blue[2]);
    emitVertex(*tessellator, 0.0f, 0.0f, -1.0f, xMax, yMin, zCoord, uCornerB, vCornerB);
    (*tessellator)
        .color(ctx_.faceState.colors.red[3], ctx_.faceState.colors.green[3], ctx_.faceState.colors.blue[3]);
    emitVertex(*tessellator, 0.0f, 0.0f, -1.0f, xMin, yMin, zCoord, vMin, uCornerA);
  } else {
    emitVertex(*tessellator, 0.0f, 0.0f, -1.0f, xMin, yMax, zCoord, uMin, vCornerA);
    emitVertex(*tessellator, 0.0f, 0.0f, -1.0f, xMax, yMax, zCoord, uMax, vMax);
    emitVertex(*tessellator, 0.0f, 0.0f, -1.0f, xMax, yMin, zCoord, uCornerB, vCornerB);
...
void BlockFaceRenderer::renderWestFace(
  ...
  if(ctx_.faceState.useAo) {
    (*tessellator)
        .color(ctx_.faceState.colors.red[0], ctx_.faceState.colors.green[0], ctx_.faceState.colors.blue[0]);
    emitVertex(*tessellator, 0.0f, 0.0f, 1.0f, xMin, yMax, zCoord, uMax, vMax);
    (*tessellator)
        .color(ctx_.faceState.colors.red[1], ctx_.faceState.colors.green[1], ctx_.faceState.colors.blue[1]);
    emitVertex(*tessellator, 0.0f, 0.0f, 1.0f, xMin, yMin, zCoord, uCornerB, vCornerB);
    (*tessellator)
        .color(ctx_.faceState.colors.red[2], ctx_.faceState.colors.green[2], ctx_.faceState.colors.blue[2]);
    emitVertex(*tessellator, 0.0f, 0.0f, 1.0f, xMax, yMin, zCoord, vMin, uCornerA);
    (*tessellator)
        .color(ctx_.faceState.colors.red[3], ctx_.faceState.colors.green[3], ctx_.faceState.colors.blue[3]);
    emitVertex(*tessellator, 0.0f, 0.0f, 1.0f, xMax, yMax, zCoord, uMin, vCornerA);
  } else {
    emitVertex(*tessellator, 0.0f, 0.0f, 1.0f, xMin, yMax, zCoord, uMax, vMax);
    emitVertex(*tessellator, 0.0f, 0.0f, 1.0f, xMin, yMin, zCoord, uCornerB, vCornerB);
    emitVertex(*tessellator, 0.0f, 0.0f, 1.0f, xMax, yMin, zCoord, vMin, uCornerA);
...
void BlockFaceRenderer::renderNorthFace(
  ...
  if(ctx_.faceState.useAo) {
    (*tessellator)
        .color(ctx_.faceState.colors.red[0], ctx_.faceState.colors.green[0], ctx_.faceState.colors.blue[0]);
    emitVertex(*tessellator, -1.0f, 0.0f, 0.0f, xCoord, yMax, zMax, uMin, vCornerA);
    (*tessellator)
        .color(ctx_.faceState.colors.red[1], ctx_.faceState.colors.green[1], ctx_.faceState.colors.blue[1]);
    emitVertex(*tessellator, -1.0f, 0.0f, 0.0f, xCoord, yMax, zMin, uMax, vMax);
    (*tessellator)
        .color(ctx_.faceState.colors.red[2], ctx_.faceState.colors.green[2], ctx_.faceState.colors.blue[2]);
    emitVertex(*tessellator, -1.0f, 0.0f, 0.0f, xCoord, yMin, zMin, uCornerB, vCornerB);
    (*tessellator)
        .color(ctx_.faceState.colors.red[3], ctx_.faceState.colors.green[3], ctx_.faceState.colors.blue[3]);
    emitVertex(*tessellator, -1.0f, 0.0f, 0.0f, xCoord, yMin, zMax, vMin, uCornerA);
  } else {
    emitVertex(*tessellator, -1.0f, 0.0f, 0.0f, xCoord, yMax, zMax, uMin, vCornerA);
    emitVertex(*tessellator, -1.0f, 0.0f, 0.0f, xCoord, yMax, zMin, uMax, vMax);
    emitVertex(*tessellator, -1.0f, 0.0f, 0.0f, xCoord, yMin, zMin, uCornerB, vCornerB);
...
void BlockFaceRenderer::renderSouthFace(
  ...
  if(ctx_.faceState.useAo) {
    (*tessellator)
        .color(ctx_.faceState.colors.red[0], ctx_.faceState.colors.green[0], ctx_.faceState.colors.blue[0]);
    emitVertex(*tessellator, 1.0f, 0.0f, 0.0f, xCoord, yMin, zMax, uCornerB, vCornerB);
    (*tessellator)
        .color(ctx_.faceState.colors.red[1], ctx_.faceState.colors.green[1], ctx_.faceState.colors.blue[1]);
    emitVertex(*tessellator, 1.0f, 0.0f, 0.0f, xCoord, yMin, zMin, vMin, uCornerA);
    (*tessellator)
        .color(ctx_.faceState.colors.red[2], ctx_.faceState.colors.green[2], ctx_.faceState.colors.blue[2]);
    emitVertex(*tessellator, 1.0f, 0.0f, 0.0f, xCoord, yMax, zMin, uMin, vCornerA);
    (*tessellator)
        .color(ctx_.faceState.colors.red[3], ctx_.faceState.colors.green[3], ctx_.faceState.colors.blue[3]);
    emitVertex(*tessellator, 1.0f, 0.0f, 0.0f, xCoord, yMax, zMax, uMax, vMax);
  } else {
    emitVertex(*tessellator, 1.0f, 0.0f, 0.0f, xCoord, yMin, zMax, uCornerB, vCornerB);
    emitVertex(*tessellator, 1.0f, 0.0f, 0.0f, xCoord, yMin, zMin, vMin, uCornerA);
    emitVertex(*tessellator, 1.0f, 0.0f, 0.0f, xCoord, yMax, zMin, uMin, vCornerA);
