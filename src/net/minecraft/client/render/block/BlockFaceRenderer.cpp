...
void emitVertex(Tessellator& tessellator, const BlockFaceRenderState& state, int corner, float nx, float ny, float nz, double x, double y, double z, double u, double v) {
  (void)state;
  (void)corner;
  emitBlockVertex(tessellator, nx, ny, nz, x, y, z, u, v);
}
} // namespace
void BlockFaceRenderer::renderBottomFace(net::minecraft::block::Block& /*block*/, double x, double y, double z,
                                         int texture) {
...
void BlockFaceRenderer::renderTopFace(net::minecraft::block::Block& /*block*/, double x, double y, double z,
                                      int texture) {
  Tessellator* tessellator = nullptr;
...
void BlockFaceRenderer::renderEastFace(net::minecraft::block::Block& /*block*/, double x, double y, double z,
                                       int texture) {
  double uMin;
  Tessellator* tessellator = nullptr;
...
void BlockFaceRenderer::renderWestFace(net::minecraft::block::Block& /*block*/, double x, double y, double z,
                                       int texture) {
  double uMin;
  Tessellator* tessellator = nullptr;
...
void BlockFaceRenderer::renderNorthFace(net::minecraft::block::Block& /*block*/, double x, double y, double z,
                                        int texture) {
  double uMin;
  Tessellator* tessellator = nullptr;
...
void BlockFaceRenderer::renderSouthFace(net::minecraft::block::Block& /*block*/, double x, double y, double z,
                                        int texture) {
  double uMin;
  Tessellator* tessellator = nullptr;
