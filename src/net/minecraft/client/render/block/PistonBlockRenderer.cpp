...
void PistonBlockRenderer::renderExtensionRod(int axis,
                                             double x1,
                                             double x2,
                                             double y1,
                                             double y2,
...
bool PistonBlockRenderer::renderPistonHead(
  ...
  case 0: {
    ...
    cube_.renderBlock(block, x, y, z);
    renderExtensionRod(0,
                       (float)x + 0.375f,
                       (float)x + 0.625f,
                       (float)y + 0.25f,
                       (float)y + 0.25f + extensionDepth,
                       (float)z + 0.625f,
                       (float)z + 0.625f,
                       brightness * 0.8f,
                       textureScrollU);
  ...
  case 1: {
    ...
    renderExtensionRod(0,
                       (float)x + 0.375f,
                       (float)x + 0.625f,
                       (float)y - 0.25f + 1.0f - extensionDepth,
                       (float)y - 0.25f + 1.0f,
                       (float)z + 0.625f,
                       (float)z + 0.625f,
                       brightness * 0.8f,
  ...
  case 2: {
    ...
    cube_.renderBlock(block, x, y, z);
    renderExtensionRod(1,
                       (float)x + 0.375f,
                       (float)x + 0.375f,
                       (float)y + 0.625f,
                       (float)y + 0.375f,
                       (float)z + 0.25f,
                       (float)z + 0.25f + extensionDepth,
                       brightness * 0.6f,
                       textureScrollU);
    renderExtensionRod(1,
                       (float)x + 0.625f,
  ...
  case 3: {
    ...
    renderExtensionRod(1,
                       ...
                       (float)y + 0.625f,
                       (float)y + 0.375f,
                       (float)z - 0.25f + 1.0f - extensionDepth,
                       (float)z - 0.25f + 1.0f,
                       brightness * 0.6f,
                       textureScrollU);
    renderExtensionRod(1,
  ...
  case 4: {
    ...
    cube_.renderBlock(block, x, y, z);
    renderExtensionRod(2,
                       (float)x + 0.25f,
                       (float)x + 0.25f + extensionDepth,
                       (float)y + 0.375f,
                       (float)y + 0.375f,
                       (float)z + 0.625f,
                       (float)z + 0.375f,
  ...
  case 5: {
    ...
    cube_.renderBlock(block, x, y, z);
    renderExtensionRod(2,
                       (float)x - 0.25f + 1.0f - extensionDepth,
                       (float)x - 0.25f + 1.0f,
                       (float)y + 0.375f,
                       (float)y + 0.375f,
                       (float)z + 0.625f,
