...
void BlockRenderManager::renderWithTexture(net::minecraft::block::Block& block, int x, int y, int z, int textureOverrideIn)
{
...
void BlockRenderManager::renderPistonHeadWithoutCulling(net::minecraft::block::Block& block, int x, int y, int z, bool extendedHalfway)
{
...
void BlockRenderManager::renderFallingBlockEntity(net::minecraft::block::Block& block, net::minecraft::World* world, int x, int y, int z)
{
...
{
    return renderType == BlockRenderType::FULL_CUBE
        || renderType == BlockRenderType::CACTUS
        || renderType == BlockRenderType::STAIRS
        || renderType == BlockRenderType::FENCE
