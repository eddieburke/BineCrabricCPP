...

{
    ...
    if (blockMeta == 1) {
        ...
        renderTiltedTorch(block, static_cast<double>(x) - wallInset, static_cast<double>(y) + yOffset, z, -tiltAmount, 0.0);
        ...
        renderTiltedTorch(block, x, static_cast<double>(y) + yOffset, static_cast<double>(z) - wallInset, 0.0, -tiltAmount);
...

{
    ...
    tessellator.vertex(x + xTilt * (1.0 - capHeight) - stickHalf, y + capHeight, z + zTilt * (1.0 - capHeight) - stickHalf, capUMin, capUMax);

    tessellator.vertex(x + xTilt * (1.0 - capHeight) - stickHalf, y + capHeight, z + zTilt * (1.0 - capHeight) + stickHalf, capUMin, capVMax);

    tessellator.vertex(x + xTilt * (1.0 - capHeight) + stickHalf, y + capHeight, z + zTilt * (1.0 - capHeight) + stickHalf, capVMin, capVMax);

    tessellator.vertex(x + xTilt * (1.0 - capHeight) + stickHalf, y + capHeight, z + zTilt * (1.0 - capHeight) - stickHalf, capVMin, capUMax);
