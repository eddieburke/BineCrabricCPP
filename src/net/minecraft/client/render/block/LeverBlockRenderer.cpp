...
bool LeverBlockRenderer::render(net::minecraft::block::Block& block, int x, int y, int z) {
  ...
  if(facing == 5) {
    ctx_.setRenderBounds(
        0.5f - halfWidth, 0.0f, 0.5f - halfDepth, 0.5f + halfWidth, handleHeight, 0.5f + halfDepth);
  } else if(facing == 6) {
    ctx_.setRenderBounds(
        0.5f - halfDepth, 0.0f, 0.5f - halfWidth, 0.5f + halfDepth, handleHeight, 0.5f + halfWidth);
  } else if(facing == 4) {
    ctx_.setRenderBounds(
        0.5f - halfWidth, 0.5f - halfDepth, 1.0f - handleHeight, 0.5f + halfWidth, 0.5f + halfDepth, 1.0f);
  } else if(facing == 3) {
    ctx_.setRenderBounds(
        0.5f - halfWidth, 0.5f - halfDepth, 0.0f, 0.5f + halfWidth, 0.5f + halfDepth, handleHeight);
  } else if(facing == 2) {
    ctx_.setRenderBounds(
        1.0f - handleHeight, 0.5f - halfDepth, 0.5f - halfWidth, 1.0f, 0.5f + halfDepth, 0.5f + halfWidth);
  } else if(facing == 1) {
    ctx_.setRenderBounds(
        0.0f, 0.5f - halfDepth, 0.5f - halfWidth, handleHeight, 0.5f + halfDepth, 0.5f + halfWidth);
  }
