...
bool RepeaterBlockRenderer::render(net::minecraft::block::Block& block, int x, int y, int z)
{
    ...
    torch_.renderTiltedTorch(block, static_cast<double>(x) + torchXOffsetA, static_cast<double>(y) + torchYOffset, static_cast<double>(z) + torchZOffsetA, 0.0, 0.0);
    torch_.renderTiltedTorch(block, static_cast<double>(x) + torchXOffsetB, static_cast<double>(y) + torchYOffset, static_cast<double>(z) + torchZOffsetB, 0.0, 0.0);
