...
void assignAoVertexColors(const option::ResolvedRenderOptions& resolved, BlockFaceRenderState& state, float corner0,
                          float corner1, float corner2, float corner3, bool applyTint, float shade, float red,
...
bool CubeBlockRenderer::renderSmooth(net::minecraft::block::Block& block, int x, int y, int z, float red, float green,
  ...
  if(ctx_.skipFaceCulling || ctx_.isSideVisible(block, x, y - 1, z, 0)) {
    if(ctx_.useSurroundingBrightness > 0) {
      ...
      const float southWestBottomBrightness = bottomSouthEdgeTranslucent || bottomEastEdgeTranslucent
                                                  ...
                                                  : southBottomBrightness;
      corner0 =
          (northWestBottomBrightness + northBottomBrightness + westBottomBrightness + bottomBrightness) / 4.0f;
      corner3 =
          (westBottomBrightness + bottomBrightness + southWestBottomBrightness + southBottomBrightness) / 4.0f;
      corner2 =
          (bottomBrightness + eastBottomBrightness + southBottomBrightness + southEastBottomBrightness) / 4.0f;
      corner1 =
          (northBottomBrightness + northEastBottomBrightness + bottomBrightness + eastBottomBrightness) / 4.0f;
    } else {
      corner2 = corner3 = corner0 = corner1 = bottomBrightness;
    }
    assignAoVertexColors(ctx_.opts, ctx_.faceState, corner0, corner1, corner2, corner3, tintDown, 0.5f, red, green,
                         blue);
  ...
  if(ctx_.skipFaceCulling || ctx_.isSideVisible(block, x, y + 1, z, 1)) {
    ...
    assignAoVertexColors(ctx_.opts, ctx_.faceState, corner0, corner1, corner2, corner3, tintUp, 1.0f, red, green,
                         blue);
  ...
  if(ctx_.skipFaceCulling || ctx_.isSideVisible(block, x, y, z - 1, 2)) {
    ...
    assignAoVertexColors(ctx_.opts, ctx_.faceState, corner0, corner1, corner2, corner3, tintEast, 0.8f, red, green,
                         blue);
  ...
  if(ctx_.skipFaceCulling || ctx_.isSideVisible(block, x, y, z + 1, 3)) {
    ...
    assignAoVertexColors(ctx_.opts, ctx_.faceState, corner0, corner1, corner2, corner3, tintWest, 0.8f, red, green,
                         blue);
  ...
  if(ctx_.skipFaceCulling || ctx_.isSideVisible(block, x - 1, y, z, 4)) {
    if(ctx_.useSurroundingBrightness > 0) {
      ...
      const float northWestTopBrightness = southWestEdgeTranslucent || topWestEdgeTranslucent
                                               ...
                                               : northWestBrightness;
      corner3 =
          (northBottomBrightness + northWestBottomBrightness + northBrightness + northWestBrightness) / 4.0f;
      ...
      corner2 =
          (northEastBottomBrightness + northBottomBrightness + northEastBrightness + northBrightness) / 4.0f;
    } else {
      corner2 = corner3 = corner0 = corner1 = northBrightness;
    }
    assignAoVertexColors(ctx_.opts, ctx_.faceState, corner0, corner1, corner2, corner3, tintNorth, 0.6f, red, green,
                         blue);
  ...
  if(ctx_.skipFaceCulling || ctx_.isSideVisible(block, x + 1, y, z, 5)) {
    if(ctx_.useSurroundingBrightness > 0) {
      ...
      const float southWestTopBrightness = topEastEdgeTranslucent || southEastEdgeTranslucent
                                               ...
                                               : southWestBrightness;
      corner0 =
          (southBottomBrightness + southWestBottomBrightness + southBrightness + southWestBrightness) / 4.0f;
      ...
      corner1 =
          (southEastBottomBrightness + southBottomBrightness + southEastBrightness + southBrightness) / 4.0f;
    } else {
      corner2 = corner3 = corner0 = corner1 = southBrightness;
    }
    assignAoVertexColors(ctx_.opts, ctx_.faceState, corner0, corner1, corner2, corner3, tintSouth, 0.6f, red, green,
                         blue);
...
bool CubeBlockRenderer::renderFlat(net::minecraft::block::Block& block, int x, int y, int z, float red, float green,
  ...
  if(ctx_.skipFaceCulling || ctx_.isSideVisible(block, x, y, z - 1, 2)) {
    ...
    faces_.renderEastFace(block, x, y, z, textureId);
    if(fancyWaterSideOverlayActive(ctx_.opts) && textureId == 3 && ctx_.textureOverride < 0) {
      tessellator.color(horizRed * brightness * red, horizGreen * brightness * green,
                        horizBlue * brightness * blue);
      faces_.renderEastFace(block, x, y, z, 38);
    }
    drewAnyFace = true;
  }
...
bool CubeBlockRenderer::renderCactus(net::minecraft::block::Block& block, int x, int y, int z, float red, float green,
  ...
  if(ctx_.skipFaceCulling || ctx_.isSideVisible(block, x, y, z - 1, 2)) {
    ...
    tessellator.color(horizShade * red * brightness, horizShade * green * brightness,
                      horizShade * blue * brightness);
