...
class CrossBlockRenderer {
   ...
   private:
    void render(net::minecraft::block::Block& block,
                int metadata,
                double x,
                double y,
                double z,
...
class PistonBlockRenderer {
   ...
   private:
    void renderExtensionRod(int axis,
                            double x1,
                            double x2,
                            double y1,
                            double y2,
...
class InventoryBlockRenderer {
   public:
    InventoryBlockRenderer(BlockRenderContext& ctx,
                           BlockFaceRenderer& faces,
                           CrossBlockRenderer& cross,
                           CropBlockRenderer& crop,
                           TorchBlockRenderer& torch)
