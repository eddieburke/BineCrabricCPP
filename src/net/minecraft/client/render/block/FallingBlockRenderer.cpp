...
void FallingBlockRenderer::renderFallingBlockEntity(net::minecraft::block::Block& block, net::minecraft::World* world,
                                                    int x, int y, int z) {
  ...
  tessellator.color(shadeBottom * neighborBrightness, shadeBottom * neighborBrightness,
                    shadeBottom * neighborBrightness);
  ...
  tessellator.color(shadeNorthSouth * neighborBrightness, shadeNorthSouth * neighborBrightness,
  ...
  tessellator.color(shadeEastWest * neighborBrightness, shadeEastWest * neighborBrightness,
                    shadeEastWest * neighborBrightness);
