...
bool BedBlockRenderer::render(net::minecraft::block::Block& block, int x, int y, int z) {
  ...
  if(skipFaceDir != 2 && (ctx_.skipFaceCulling || block.isSideVisible(ctx_.blockView, x, y, z - 1, 2))) {
    ...
    tessellator.color(shadeNorthSouth * northBrightness, shadeNorthSouth * northBrightness,
                      shadeNorthSouth * northBrightness);
  ...
  if(skipFaceDir != 3 && (ctx_.skipFaceCulling || block.isSideVisible(ctx_.blockView, x, y, z + 1, 3))) {
    ...
    tessellator.color(shadeNorthSouth * southBrightness, shadeNorthSouth * southBrightness,
                      shadeNorthSouth * southBrightness);
  ...
  if(skipFaceDir != 4 && (ctx_.skipFaceCulling || block.isSideVisible(ctx_.blockView, x - 1, y, z, 4))) {
    ...
    tessellator.color(shadeEastWest * westBrightness, shadeEastWest * westBrightness,
                      shadeEastWest * westBrightness);
  ...
  if(skipFaceDir != 5 && (ctx_.skipFaceCulling || block.isSideVisible(ctx_.blockView, x + 1, y, z, 5))) {
    ...
    tessellator.color(shadeEastWest * eastBrightness, shadeEastWest * eastBrightness,
                      shadeEastWest * eastBrightness);
