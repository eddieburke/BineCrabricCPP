...
namespace {
void emitCrossQuad(Tessellator& tessellator, double x0, double y0, double z0, double u0, double v0, double x1,
                   double y1, double z1, double u1, double v1, double x2, double y2, double z2, double u2, double v2,
...
void CrossBlockRenderer::render(net::minecraft::block::Block& block, int metadata, double x, double y, double z) {
  render(block, metadata, x, y, z, static_cast<int>(std::floor(x)), static_cast<int>(std::floor(y)),
...
void CrossBlockRenderer::render(net::minecraft::block::Block& block, int metadata, double x, double y, double z,
  ...
  emitCrossQuad(tessellator, x0, y + 1.0, z0, uMin, vMin, x0, y + 0.0, z0, uMin, vMax, x1, y + 0.0, z1, uMax,
                vMax, x1, y + 1.0, z1, uMax, vMin);
  emitCrossQuad(tessellator, x1, y + 1.0, z1, uMin, vMin, x1, y + 0.0, z1, uMin, vMax, x0, y + 0.0, z0, uMax,
                vMax, x0, y + 1.0, z0, uMax, vMin);
  emitCrossQuad(tessellator, x0, y + 1.0, z1, uMin, vMin, x0, y + 0.0, z1, uMin, vMax, x1, y + 0.0, z0, uMax,
                vMax, x1, y + 1.0, z0, uMax, vMin);
  emitCrossQuad(tessellator, x1, y + 1.0, z0, uMin, vMin, x1, y + 0.0, z0, uMin, vMax, x0, y + 0.0, z1, uMax,
                vMax, x0, y + 1.0, z1, uMax, vMin);
}
} // namespace net::minecraft::client::render::block
