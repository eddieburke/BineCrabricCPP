...
public:
    ...
    void prepare(net::minecraft::World* worldIn, ::net::minecraft::client::texture::TextureManager* textureManagerIn, font::TextRenderer* textRendererIn, const net::minecraft::Entity* cameraIn, float tickDelta);

    void render(const net::minecraft::block::entity::BlockEntity& blockEntity, float tickDelta);

    void render(const net::minecraft::block::entity::BlockEntity& blockEntity, double x, double y, double z, float tickDelta)
    {
