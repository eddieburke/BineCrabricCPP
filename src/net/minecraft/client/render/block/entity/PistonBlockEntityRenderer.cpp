...
void PistonBlockEntityRenderer::render(const net::minecraft::block::entity::BlockEntity& blockEntity, double x,
  ...
  if(block == net::minecraft::block::Block::PISTON_HEAD && piston->getProgress(tickDelta) < 0.5f) {
    ...
    if(pistonBlock != nullptr && net::minecraft::block::Block::PISTON_HEAD != nullptr) {
      ...
      blockRenderManager.renderPistonHeadWithoutCulling(net::minecraft::block::Block::PISTON_HEAD->id, piston->x,
                                                        piston->y, piston->z,
