...
bool RenderTarget::initialize(int widthIn, int heightIn) {
    ...
    gl::texImage2D(
        gl::cap::Texture2D, 0, gl::pixel::Rgb, width, height, 0, gl::pixel::Rgb, gl::pixel::UnsignedByte, nullptr);
    ...
    gl::framebufferTexture2D(
        gl::framebuffer::Framebuffer, gl::framebuffer::ColorAttachment0, gl::cap::Texture2D, colorTexture, 0);
    ...
    gl::framebufferRenderbuffer(gl::framebuffer::Framebuffer,
...
bool RenderTargetManager::render(int handle,
