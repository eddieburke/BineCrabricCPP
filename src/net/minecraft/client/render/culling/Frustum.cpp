...
constexpr int kGlProjectionMatrix = 0x0BA7; // GL_PROJECTION_MATRIX (2983)
constexpr int kGlModelviewMatrix = 0x0BA6;  // GL_MODELVIEW_MATRIX (2982)
...
{
    const float length = MathHelper::sqrt(
...
{
    gl::GL11::glGetFloatv(kGlProjectionMatrix, projectionMatrix.data());
    gl::GL11::glGetFloatv(kGlModelviewMatrix, modelMatrix.data());
