...
public:
  ...
  void renderGuiItem(::net::minecraft::client::font::TextRenderer& textRenderer,
                     ::net::minecraft::client::texture::TextureManager& textureManager, const ItemStack& stack, int x,
                     int y);
...
private:
  void renderCustomModelInGui(::net::minecraft::client::texture::TextureManager& textureManager, const ItemStack& stack,
                              int x, int y);
  void renderBlockItemInGui(::net::minecraft::client::texture::TextureManager& textureManager, const ItemStack& stack,
                            int x, int y);
  void renderSpriteItemInGui(::net::minecraft::client::texture::TextureManager& textureManager,
                             const ItemStack& stack, int x, int y);
  void drawCountLabel(::net::minecraft::client::font::TextRenderer& textRenderer, const ItemStack& stack, int x,
                      int y);
