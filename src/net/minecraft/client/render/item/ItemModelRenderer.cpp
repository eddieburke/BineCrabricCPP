...
net::minecraft::block::TerrainAtlasUv spriteUv(const ItemStack& stack) {
  ...
  return {static_cast<double>((sprite % 16) * 16) / 256.0, static_cast<double>((sprite % 16) * 16 + 16) / 256.0,
          static_cast<double>((sprite / 16) * 16) / 256.0, static_cast<double>((sprite / 16) * 16 + 16) / 256.0};
}
