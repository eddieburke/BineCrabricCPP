...
struct OptionSpec {
  ...
  int saveOrder = 0;
  enum class Kind { Slider,
                    Toggle,
                    Cycle,
                    Hidden } kind = Kind::Toggle;
...
inline OptionSpec makeSlider(const char* key, int saveOrder, ApplyFlags intFx, ApplyFlags floatFx,
                             float (*getF)(const GameOptions&), void (*setF)(GameOptions&, float),
                             void (*loadFn)(GameOptions&, std::string_view),
                             void (*saveFn)(const GameOptions&, std::ostream&),
                             bool (*isEnabled)(const GameOptions&) = nullptr) {
  return {
      key, saveOrder, OptionSpec::Kind::Slider, intFx, floatFx, getF, setF, nullptr, nullptr, loadFn, saveFn,
      isEnabled, nullptr};
}
inline OptionSpec makeToggle(const char* key, int saveOrder, ApplyFlags flags, bool (*getB)(const GameOptions&),
                             void (*cyc)(GameOptions&, int), void (*loadFn)(GameOptions&, std::string_view),
                             void (*saveFn)(const GameOptions&, std::ostream&),
                             bool (*isEnabled)(const GameOptions&) = nullptr) {
  return {key,
          saveOrder,
...
inline OptionSpec makeCycle(const char* key, int saveOrder, ApplyFlags flags, void (*cyc)(GameOptions&, int),
                            void (*loadFn)(GameOptions&, std::string_view),
                            void (*saveFn)(const GameOptions&, std::ostream&),
                            bool (*getB)(const GameOptions&) = nullptr, bool (*isEnabled)(const GameOptions&) = nullptr,
...
inline OptionSpec makeHidden(const char* key, int saveOrder, ApplyFlags flags, bool (*getB)(const GameOptions&),
                             void (*loadFn)(GameOptions&, std::string_view),
                             void (*saveFn)(const GameOptions&, std::ostream&)) {
  return {key,
          saveOrder,
