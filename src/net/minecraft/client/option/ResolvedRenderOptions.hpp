...
[[nodiscard]] int chunkUpdatesPerPass(const ResolvedRenderOptions& resolved, int dirtyChunkCount = 0) noexcept;
...
[[nodiscard]] bool shouldRenderEntity(const ResolvedRenderOptions& resolved, const Entity& entity,
