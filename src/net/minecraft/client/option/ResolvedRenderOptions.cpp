...
int chunkUpdatesPerPass(const ResolvedRenderOptions& resolved, int dirtyChunkCount,
                        float gridAreaScale) noexcept {
...
bool shouldRenderEntity(const ResolvedRenderOptions& resolved, const Entity& entity, const Vec3d& cameraPos) {
  ...
  const double sideLength =
      std::max({entity.boundingBox.maxX - entity.boundingBox.minX, entity.boundingBox.maxY - entity.boundingBox.minY,
