...
public:
    void setClient(Minecraft* client) { client_ = client; }
    ...
    [[nodiscard]] const std::string& tutorial() const { return tutorial_; }
    [[nodiscard]] bool empty() const { return current_.empty() && tutorial_.empty(); }
