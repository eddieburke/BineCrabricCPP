...
void GameMenuScreen::init()
{
    ...
    addCenteredActionButton(layout::gameMenuButtonY(h, layout::kGameMenuQuitOffset), quitText, [this] { saveAndQuit(); });
    addCenteredActionButton(layout::gameMenuButtonY(h, layout::kGameMenuBackOffset), "Back to game", [this] { resumeGame(); });
    addCenteredActionButton(layout::gameMenuButtonY(h, layout::kGameMenuOptionsOffset), "Options...", [this] { openOptions(); });
    ...
    addActionButton(layout::centerBtnX(w) + layout::kSplitButtonWidth + 4,
        ...
        layout::kSplitButtonWidth, layout::kDefaultButtonHeight, "Stats",
        [this] { openStats(); });
}
