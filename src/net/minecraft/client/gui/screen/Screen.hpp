...
public:
  ...
  widget::ActionButtonWidget& addActionButton(int x, int y, int width, int height, std::string text,
                                              std::function<void()> onClick);
  widget::ActionButtonWidget& addActionButton(int id, int x, int y, int width, int height, std::string text,
                                              std::function<void()> onClick);
  widget::ActionButtonWidget& addCenteredActionButton(int y, std::string text, std::function<void()> onClick);
  widget::ActionButtonWidget& addCenteredActionButton(int y, int width, int height, std::string text,
                                                      std::function<void()> onClick);
