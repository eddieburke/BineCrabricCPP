...
void VideoOptionsScreen::init()
{
    ...
    addActionButton(x1, startY, 310, layout::kDefaultButtonHeight, "Quality...",
        [this, returnHere] {
            options_->save();
            navigateTo([returnHere, opts = options_]() {
                return makeQualitySettingsScreen(returnHere, opts);
            });
        });
    addActionButton(x1, startY + layout::kRowSpacing, 150, layout::kDefaultButtonHeight, "Performance...",
        [this, returnHere] {
            options_->save();
            navigateTo([returnHere, opts = options_]() {
                return makePerformanceSettingsScreen(returnHere, opts);
            });
        });
    addActionButton(x2, startY + layout::kRowSpacing, 150, layout::kDefaultButtonHeight, "Details...",
        [this, returnHere] {
            options_->save();
            navigateTo([returnHere, opts = options_]() {
                return makeDetailSettingsScreen(returnHere, opts);
            });
        });
    addActionButton(x1, startY + layout::kRowSpacing * 2, 150, layout::kDefaultButtonHeight, "Animations...",
        [this, returnHere] {
            options_->save();
            navigateTo([returnHere, opts = options_]() {
                return makeAnimationSettingsScreen(returnHere, opts);
            });
        });
    addActionButton(x2, startY + layout::kRowSpacing * 2, 150, layout::kDefaultButtonHeight, "World...",
        [this, returnHere] {
            options_->save();
            navigateTo([returnHere, opts = options_]() {
                return std::make_unique<WorldSettingsScreen>(returnHere, opts);
            });
        });
    addActionButton(x1, startY + layout::kRowSpacing * 3, 150, layout::kDefaultButtonHeight, "3D Settings...",
        [this, returnHere] {
            options_->save();
            navigateTo([returnHere, opts = options_]() {
                return makeStereoSettingsScreen(returnHere, opts);
            });
        });
    addCenteredActionButton(startY + layout::kRowSpacing * 4,
