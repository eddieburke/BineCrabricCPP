...
std::array<OptionSpec, 8> kSpecs{{
    d::makeCycle("animatedWater", 36, ApplyFlags::None, d::cycleIntMod<&GameOptions::animatedWater, 2>,
                 d::loadIntMember<&GameOptions::animatedWater>, d::saveIntMember<&GameOptions::animatedWater>),
    d::makeCycle("animatedLava", 37, ApplyFlags::None, d::cycleIntMod<&GameOptions::animatedLava, 2>,
                 d::loadIntMember<&GameOptions::animatedLava>, d::saveIntMember<&GameOptions::animatedLava>),
    d::makeToggle("animatedFire", 38, ApplyFlags::None, d::getBoolMember<&GameOptions::animatedFire>,
                  d::cycleBoolMember<&GameOptions::animatedFire>, d::loadBoolMember<&GameOptions::animatedFire>,
                  d::saveBoolMember<&GameOptions::animatedFire>),
    d::makeToggle("animatedPortal", 39, ApplyFlags::None, d::getBoolMember<&GameOptions::animatedPortal>,
                  d::cycleBoolMember<&GameOptions::animatedPortal>, d::loadBoolMember<&GameOptions::animatedPortal>,
                  d::saveBoolMember<&GameOptions::animatedPortal>),
    d::makeToggle("animatedRedstone", 40, ApplyFlags::None, d::getBoolMember<&GameOptions::animatedRedstone>,
    ...
    d::makeToggle("animatedExplosion", 41, ApplyFlags::None, d::getBoolMember<&GameOptions::animatedExplosion>,
    ...
    d::makeToggle("animatedFlame", 42, ApplyFlags::None, d::getBoolMember<&GameOptions::animatedFlame>,
                  d::cycleBoolMember<&GameOptions::animatedFlame>, d::loadBoolMember<&GameOptions::animatedFlame>,
                  d::saveBoolMember<&GameOptions::animatedFlame>),
    d::makeToggle("animatedSmoke", 43, ApplyFlags::None, d::getBoolMember<&GameOptions::animatedSmoke>,
                  d::cycleBoolMember<&GameOptions::animatedSmoke>, d::loadBoolMember<&GameOptions::animatedSmoke>,
...
protected:
  void buildOptions(OptionGuiBuilder& gui) override {
    ...
    gui.customCycle(x1, y0, "animatedWater",
                    [animLabel](const GameOptions& o) { return animLabel("Water Animated", o.animatedWater); });
    gui.customCycle(x2, y0, "animatedLava",
                    [animLabel](const GameOptions& o) { return animLabel("Lava Animated", o.animatedLava); });
...
makeAnimationSettingsScreen(std::function<std::unique_ptr<screen::Screen>()> parentFactory,
