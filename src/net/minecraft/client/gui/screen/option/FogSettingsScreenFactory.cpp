...
std::array<OptionSpec, 10> kSpecs{{
    d::makeToggle("fogFancy",
                  54,
                  ApplyFlags::None,
                  d::getBoolMember<&GameOptions::fogFancy>,
                  d::cycleBoolMember<&GameOptions::fogFancy>,
                  d::loadBoolMember<&GameOptions::fogFancy>,
                  d::saveBoolMember<&GameOptions::fogFancy>),
    d::makeCycle("fogProjection",
                 55,
                 ApplyFlags::None,
                 d::cycleIntMod<&GameOptions::fogProjection, 2>,
                 d::loadIntMember<&GameOptions::fogProjection>,
                 d::saveIntMember<&GameOptions::fogProjection>,
                 nullptr,
                 fogCustomEnabled),
    d::makeSlider("fogStart",
                  56,
                  ApplyFlags::None,
                  ApplyFlags::None,
                  d::getFloatMember<&GameOptions::fogStart>,
                  d::setFloatMember<&GameOptions::fogStart>,
                  d::loadFloatMember<&GameOptions::fogStart>,
                  d::saveFloatMember<&GameOptions::fogStart>,
                  fogLinearStartEnd),
    d::makeCycle("fogMode",
                 57,
                 ApplyFlags::None,
                 d::cycleIntMod<&GameOptions::fogMode, 2>,
                 d::loadIntMember<&GameOptions::fogMode>,
                 d::saveIntMember<&GameOptions::fogMode>,
                 nullptr,
                 fogCustomEnabled),
    d::makeSlider("fogEnd",
                  58,
                  ApplyFlags::None,
                  ApplyFlags::None,
                  d::getFloatMember<&GameOptions::fogEnd>,
                  d::setFloatMember<&GameOptions::fogEnd>,
                  d::loadFloatMember<&GameOptions::fogEnd>,
                  d::saveFloatMember<&GameOptions::fogEnd>,
                  fogLinearStartEnd),
    d::makeSlider("fogDensity",
                  59,
                  ApplyFlags::None,
                  ApplyFlags::None,
                  d::getFloatMember<&GameOptions::fogDensity>,
                  d::setFloatMember<&GameOptions::fogDensity>,
                  d::loadFloatMember<&GameOptions::fogDensity>,
                  d::saveFloatMember<&GameOptions::fogDensity>,
                  fogExpDensity),
    d::makeCycle("fogColorMode",
                 63,
                 ApplyFlags::None,
                 d::cycleIntMod<&GameOptions::fogColorMode, 2>,
                 d::loadIntMember<&GameOptions::fogColorMode>,
                 d::saveIntMember<&GameOptions::fogColorMode>,
                 nullptr,
                 fogCustomEnabled),
    d::makeSlider("fogColorRed",
                  60,
                  ApplyFlags::None,
                  ApplyFlags::None,
                  d::getFloatMember<&GameOptions::fogColorRed>,
                  d::setFloatMember<&GameOptions::fogColorRed>,
                  d::loadFloatMember<&GameOptions::fogColorRed>,
                  d::saveFloatMember<&GameOptions::fogColorRed>,
                  fogCustomColor),
    d::makeSlider("fogColorGreen",
                  61,
                  ApplyFlags::None,
                  ApplyFlags::None,
                  d::getFloatMember<&GameOptions::fogColorGreen>,
                  d::setFloatMember<&GameOptions::fogColorGreen>,
                  d::loadFloatMember<&GameOptions::fogColorGreen>,
                  d::saveFloatMember<&GameOptions::fogColorGreen>,
                  fogCustomColor),
    d::makeSlider("fogColorBlue",
                  62,
                  ApplyFlags::None,
                  ApplyFlags::None,
                  d::getFloatMember<&GameOptions::fogColorBlue>,
                  d::setFloatMember<&GameOptions::fogColorBlue>,
                  d::loadFloatMember<&GameOptions::fogColorBlue>,
