...
std::array<OptionSpec, 8> kSpecs {{
    d::makeSlider("music", 0, ApplyFlags::None, ApplyFlags::UpdateSound,
    ...
    d::makeSlider("sound", 1, ApplyFlags::None, ApplyFlags::UpdateSound,
    ...
    d::makeToggle("invertYMouse", 2, ApplyFlags::None,
    ...
    d::makeToggle("bobView", 6, ApplyFlags::None,
    ...
    d::makeCycle("guiScale", 5, ApplyFlags::None,
...
void OptionsScreen::init()
{
    ...
    gui.slider(x2, y0 + dy, "mouseSensitivity", sensitivity.c_str(),
        [sensitivity](const GameOptions& o) {
            ...
            return optionLabel(sensitivity.c_str(),
                std::to_string(static_cast<int>(o.mouseSensitivity * 200.0f)) + "%");
        });
    ...
    gui.i18nCycle(x2, y0 + dy * 3, "guiScale", guiScale.c_str(),
    ...
    addCenteredActionButton(navY + layout::kRowSpacing, layout::kDefaultButtonWidth,
        layout::kDefaultButtonHeight, resource::language::I18n::getTranslation("options.controls"),
        [this, returnHere] {
            options_->save();
            navigateTo([returnHere, opts = options_]() {
                return std::make_unique<KeybindsScreen>(returnHere, opts);
            });
        });
    layout::OptionsBuildContext ctx { *this, *minecraft(), *options_ };
    layout::addDoneButton(ctx, navY + layout::kRowSpacing * 3,
