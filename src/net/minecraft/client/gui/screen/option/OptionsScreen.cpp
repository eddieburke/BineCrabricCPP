...
std::array<OptionSpec, 8> kSpecs{{
    d::makeSlider("music", 0, ApplyFlags::None, ApplyFlags::UpdateSound, d::getFloatMember<&GameOptions::musicVolume>,
                  d::setFloatMember<&GameOptions::musicVolume>, d::loadFloatMember<&GameOptions::musicVolume>,
                  d::saveFloatMember<&GameOptions::musicVolume>),
    d::makeSlider("sound", 1, ApplyFlags::None, ApplyFlags::UpdateSound, d::getFloatMember<&GameOptions::soundVolume>,
                  d::setFloatMember<&GameOptions::soundVolume>, d::loadFloatMember<&GameOptions::soundVolume>,
                  d::saveFloatMember<&GameOptions::soundVolume>),
    d::makeToggle("invertYMouse", 2, ApplyFlags::None, d::getBoolMember<&GameOptions::invertYMouse>,
                  d::cycleBoolMember<&GameOptions::invertYMouse>, d::loadBoolMember<&GameOptions::invertYMouse>,
                  d::saveBoolMember<&GameOptions::invertYMouse>),
    d::makeSlider("mouseSensitivity", 3, ApplyFlags::None, ApplyFlags::None,
                  d::getFloatMember<&GameOptions::mouseSensitivity>, d::setFloatMember<&GameOptions::mouseSensitivity>,
                  d::loadFloatMember<&GameOptions::mouseSensitivity>,
                  d::saveFloatMember<&GameOptions::mouseSensitivity>),
    d::makeCycle("difficulty", 10, ApplyFlags::None, d::cycleIntMod<&GameOptions::difficulty, 4>,
                 d::loadIntMember<&GameOptions::difficulty>, d::saveIntMember<&GameOptions::difficulty>),
    d::makeSlider("fov", 14, ApplyFlags::None, ApplyFlags::None, d::getFloatMember<&GameOptions::fieldOfView>,
                  d::setFloatMember<&GameOptions::fieldOfView>, d::loadFloatMember<&GameOptions::fieldOfView>,
                  d::saveFloatMember<&GameOptions::fieldOfView>),
    d::makeToggle("bobView", 6, ApplyFlags::None, d::getBoolMember<&GameOptions::bobView>,
                  d::cycleBoolMember<&GameOptions::bobView>, d::loadBoolMember<&GameOptions::bobView>,
                  d::saveBoolMember<&GameOptions::bobView>),
    d::makeCycle("guiScale", 5, ApplyFlags::None, d::cycleIntMod<&GameOptions::guiScale, 4>,
                 d::loadIntMember<&GameOptions::guiScale>, d::saveIntMember<&GameOptions::guiScale>, nullptr, nullptr,
                 d::alwaysResize),
}};
} // namespace options_screen
...
void OptionsScreen::init() {
  ...
  gui.slider(x1, y0, "music", music.c_str(),
             [music](const GameOptions& o) { return percentLabel(music.c_str(), o.musicVolume); });
  gui.slider(x2, y0, "sound", sound.c_str(),
             [sound](const GameOptions& o) { return percentLabel(sound.c_str(), o.soundVolume); });
  ...
  gui.i18nCycle(x1, y0 + dy * 2, "difficulty", difficulty.c_str(),
                {"options.difficulty.peaceful", "options.difficulty.easy", "options.difficulty.normal",
  ...
  gui.i18nCycle(
      x2, y0 + dy * 3, "guiScale", guiScale.c_str(),
  ...
  addCenteredActionButton(navY, layout::kDefaultButtonWidth, layout::kDefaultButtonHeight,
                          resource::language::I18n::getTranslation("options.video"), [this, returnHere] {
                            options_->save();
  ...
  addCenteredActionButton(
      navY + layout::kRowSpacing, layout::kDefaultButtonWidth, layout::kDefaultButtonHeight,
      resource::language::I18n::getTranslation("options.controls"), [this, returnHere] {
        options_->save();
  ...
  layout::addDoneButton(ctx, navY + layout::kRowSpacing * 3, resource::language::I18n::getTranslation("gui.done"),
                        [this] {
                          if(options_ == nullptr || minecraft() == nullptr) {
                            return;
                          }
