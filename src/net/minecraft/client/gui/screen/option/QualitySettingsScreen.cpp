...
std::array<OptionSpec, 9> kSpecs{{
    d::makeCycle("fancyGraphics", 11, ApplyFlags::ReloadWorld, d::cycleBoolMember<&GameOptions::fancyGraphics>,
                 d::loadBoolMember<&GameOptions::fancyGraphics>, d::saveBoolMember<&GameOptions::fancyGraphics>,
                 d::getBoolMember<&GameOptions::fancyGraphics>),
    d::makeCycle("viewDistance", 4, ApplyFlags::ApplyToWorld, d::cycleIntMod<&GameOptions::viewDistance, 4>,
                 d::loadIntMember<&GameOptions::viewDistance>, d::saveIntMember<&GameOptions::viewDistance>),
    d::makeSlider("renderScale", 16, ApplyFlags::None, ApplyFlags::ApplyToWorld | ApplyFlags::ReloadWorld,
                  d::getRenderScaleSlider,
                  d::setRenderScaleSlider, d::loadFloatMember<&GameOptions::renderScale>,
                  d::saveFloatMember<&GameOptions::renderScale>),
    d::makeCycle("mipmapLevel", 17, ApplyFlags::ApplyDerived | ApplyFlags::ReloadTextures,
                 d::cycleIntMod<&GameOptions::mipmapLevel, 5>, d::loadIntMember<&GameOptions::mipmapLevel>,
                 d::saveIntMember<&GameOptions::mipmapLevel>),
    d::makeToggle("mipmapLinear", 18, ApplyFlags::ApplyDerived | ApplyFlags::ReloadTextures,
                  d::getBoolMember<&GameOptions::mipmapLinear>, d::cycleBoolMember<&GameOptions::mipmapLinear>,
                  d::loadBoolMember<&GameOptions::mipmapLinear>, d::saveBoolMember<&GameOptions::mipmapLinear>),
    d::makeHidden("ao", 12, ApplyFlags::ReloadWorld, d::getBoolMember<&GameOptions::ao>,
                  d::loadBoolMember<&GameOptions::ao>, d::saveBoolMember<&GameOptions::ao>),
    d::makeSlider("aoLevel", 19, ApplyFlags::None, ApplyFlags::ReloadWorld,
                  d::getFloatMember<&GameOptions::aoLevel>, d::setAoLevel,
                  d::loadFloatMember<&GameOptions::aoLevel>, d::saveFloatMember<&GameOptions::aoLevel>),
    d::makeSlider("brightness", 15, ApplyFlags::None, ApplyFlags::None, d::getFloatMember<&GameOptions::brightness>,
                  d::setFloatMember<&GameOptions::brightness>, d::loadFloatMember<&GameOptions::brightness>,
                  d::saveFloatMember<&GameOptions::brightness>),
    d::makeToggle("clearWater", 20, ApplyFlags::None, d::getBoolMember<&GameOptions::clearWater>,
                  d::cycleBoolMember<&GameOptions::clearWater>, d::loadBoolMember<&GameOptions::clearWater>,
...
protected:
  void buildOptions(OptionGuiBuilder& gui) override {
    ...
    gui.customCycle(x2, y0 + dy, "mipmapLevel", [](const GameOptions& o) {
      return optionLabel("Mipmap Level", o.mipmapLevel == 0
    ...
    gui.slider(x1, y0 + dy * 3, "brightness", "Brightness",
               [](const GameOptions& o) { return percentLabel("Brightness", o.brightness); });
    gui.toggle(x2, y0 + dy * 3, "clearWater", "Clear Water");
  }
};
} // namespace quality_screen
std::unique_ptr<screen::Screen>
makeQualitySettingsScreen(std::function<std::unique_ptr<screen::Screen>()> parentFactory,
