...
std::array<OptionSpec, 8> kSpecs{{
    d::makeCycle("clouds", 28, ApplyFlags::None, d::cycleIntMod<&GameOptions::clouds, 4>,
                 d::loadIntMember<&GameOptions::clouds>, d::saveIntMember<&GameOptions::clouds>),
    d::makeSlider("cloudsHeight", 29, ApplyFlags::None, ApplyFlags::None,
                  d::getFloatMember<&GameOptions::cloudsHeight>, d::setFloatMember<&GameOptions::cloudsHeight>,
                  d::loadFloatMember<&GameOptions::cloudsHeight>, d::saveFloatMember<&GameOptions::cloudsHeight>),
    d::makeCycle("trees", 30, ApplyFlags::ReloadWorld, d::cycleIntMod<&GameOptions::trees, 2>,
                 d::loadIntMember<&GameOptions::trees>, d::saveIntMember<&GameOptions::trees>),
    d::makeCycle("grass", 31, ApplyFlags::ReloadWorld, d::cycleIntMod<&GameOptions::grass, 4>,
                 d::loadIntMember<&GameOptions::grass>, d::saveIntMember<&GameOptions::grass>),
    d::makeCycle("water", 32, ApplyFlags::ReloadWorld, d::cycleIntMod<&GameOptions::water, 3>,
                 d::loadIntMember<&GameOptions::water>, d::saveIntMember<&GameOptions::water>),
    d::makeCycle("rain", 33, ApplyFlags::None, d::cycleIntMod<&GameOptions::rain, 3>,
                 d::loadIntMember<&GameOptions::rain>, d::saveIntMember<&GameOptions::rain>),
    d::makeToggle("sky", 34, ApplyFlags::None, d::getBoolMember<&GameOptions::sky>,
                  d::cycleBoolMember<&GameOptions::sky>, d::loadBoolMember<&GameOptions::sky>,
                  d::saveBoolMember<&GameOptions::sky>),
    d::makeToggle("stars", 35, ApplyFlags::None, d::getBoolMember<&GameOptions::stars>,
                  d::cycleBoolMember<&GameOptions::stars>, d::loadBoolMember<&GameOptions::stars>,
...
protected:
  void buildOptions(OptionGuiBuilder& gui) override {
    ...
    gui.slider(x2, y0, "cloudsHeight", "Cloud Height", [](const GameOptions& o) { return o.cloudsHeight == 0.0f
                                                                                             ? optionLabel("Cloud Height", "OFF")
                                                                                             : optionLabel("Cloud Height",
                                                                                                           std::to_string(static_cast<int>(o.cloudsHeight * 100.0f)) + "%"); }, cloudsHeightEnabled);
    gui.intCycle(x1, y0 + dy, "trees", "Trees", {"Fancy", "Fast"}, &GameOptions::trees);
    gui.intCycle(x2, y0 + dy, "grass", "Grass", {"Fancy", "Fast", "Better Fancy", "Better Fast"},
                 &GameOptions::grass);
