...
ConfirmScreen::ConfirmScreen(ScreenFactory returnFactory,
    ...
    : returnFactory_(std::move(returnFactory)),
      ...
      message1_(std::move(message1)),
      message2_(std::move(message2)),
...
void ConfirmScreen::init()
{
    ...
    addActionButton(layout::confirmBtnX(width(), true), y, layout::kConfirmButtonWidth,
        layout::kDefaultButtonHeight, confirmText_,
        [this] {
    ...
    addActionButton(layout::confirmBtnX(width(), false), y, layout::kConfirmButtonWidth,
        layout::kDefaultButtonHeight, cancelText_,
        [this] {
            if (minecraft() == nullptr) {
                return;
            }
