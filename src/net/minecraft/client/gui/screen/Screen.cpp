...
widget::ActionButtonWidget& Screen::addActionButton(int x, int y, std::string text, std::function<void()> onClick) {
  return addActionButton(x, y, layout::kDefaultButtonWidth, layout::kDefaultButtonHeight, std::move(text),
                         std::move(onClick));
}
widget::ActionButtonWidget& Screen::addActionButton(int x, int y, int width, int height, std::string text,
                                                    std::function<void()> onClick) {
  return addActionButton(widget::ActionButtonWidget::kNoId, x, y, width, height, std::move(text), std::move(onClick));
}
widget::ActionButtonWidget& Screen::addActionButton(int id, int x, int y, int width, int height, std::string text,
                                                    std::function<void()> onClick) {
  auto button =
...
widget::ActionButtonWidget& Screen::addCenteredActionButton(int y, std::string text, std::function<void()> onClick) {
  return addCenteredActionButton(y, layout::kDefaultButtonWidth, layout::kDefaultButtonHeight, std::move(text),
                                 std::move(onClick));
}
widget::ActionButtonWidget& Screen::addCenteredActionButton(int y, int width, int height, std::string text,
                                                            std::function<void()> onClick) {
