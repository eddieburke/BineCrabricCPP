...
class Minecraft {
   public:
    ...
    [[nodiscard]] host::LanHostCoordinator& lanHostCoordinator() noexcept {
        return *lanHostCoordinator_;
    }

    [[nodiscard]] const host::LanHostCoordinator& lanHostCoordinator() const noexcept {
        return *lanHostCoordinator_;
    }
