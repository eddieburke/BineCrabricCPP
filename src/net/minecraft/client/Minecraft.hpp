...
public:
    ...
    [[nodiscard]] render::OpenGlCapabilities* getOpenGlCapabilities();
    ...
    int displayWidth = 0;
    int displayHeight = 0;
    render::OpenGlCapabilities* openGlCapabilities = nullptr;
    ...
    struct ClientHostAdapter final : core::ClientHost {
        explicit ClientHostAdapter(Minecraft& minecraft) noexcept : minecraft_(minecraft) {}

        Minecraft* asMinecraft() noexcept override { return &minecraft_; }
        const Minecraft* asMinecraft() const noexcept override { return &minecraft_; }
        World* world() const noexcept override { return minecraft_.world; }
        entity::player::ClientPlayerEntity* player() const noexcept override { return minecraft_.player; }
        stat::PlayerStats* stats() noexcept override { return minecraft_.stats; }
        void clearInGameChat() override { minecraft_.inGameHud.clearChat(); }
        void unlockMouse() override { minecraft_.unlockMouse(); }
        void lockMouse() override;
        option::GameOptions& options() noexcept override { return minecraft_.options; }
        int displayWidth() const noexcept override { return minecraft_.displayWidth; }
        int displayHeight() const noexcept override { return minecraft_.displayHeight; }
        bool& skipGameRenderFlag() noexcept override { return minecraft_.skipGameRender; }
