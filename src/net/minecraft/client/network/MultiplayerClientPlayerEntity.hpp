...
#include "net/minecraft/stat/Stat.hpp"
...
public:
    MultiplayerClientPlayerEntity(client::Minecraft* minecraft, World* world, const client::util::Session& session, ClientNetworkHandler* networkHandler);
