...
WorldSoundListener::WorldSoundListener(Minecraft* client)
    : client_(client)
{
}
...
void WorldSoundListener::playAt(
    const std::string& sound, double x, double y, double z, float volume, float pitch)
{
...
void WorldSoundListener::playSound(
    const std::string& sound, double x, double y, double z, float volume, float pitch)
{
