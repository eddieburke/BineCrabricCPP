...
public:
    RunnableMinecraft(void* component, void* canvas, net::minecraft::MinecraftApplet* applet, int width, int height, bool fullscreen)
...
#ifdef _WIN32
        net::minecraft::client::lifecycle::reportFatalError(
            "Minecraft Native - failed to start",
