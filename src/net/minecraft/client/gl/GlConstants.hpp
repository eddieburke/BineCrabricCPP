...
inline constexpr int AlphaTest = 0x0BE0;
...
inline constexpr int RgbaInteger = 0x8D9F;
...
inline constexpr int DepthStencil = 0x84F9;
inline constexpr int UnsignedInt248 = 0x84FA;
} // namespace pixel
namespace framebuffer {
inline constexpr int Framebuffer = 0x8D40;
inline constexpr int Renderbuffer = 0x8D41;
inline constexpr int ReadFramebuffer = 0x8CA8;
inline constexpr int DrawFramebuffer = 0x8CA9;
...
inline constexpr int MaxDrawBuffers = 0x8C8B;
inline constexpr int MaxColorAttachments = 0x8CDF;
inline constexpr int Color = 0x1800; // GL_COLOR: the color buffer selector for glClearBuffer*
} // namespace framebuffer
namespace attrib {
...
inline constexpr int AmbientAndDiffuse = 0x1600;
} // namespace light
namespace fog {
...
inline constexpr int AlphaFunc = 0x0BDE;
inline constexpr int AlphaRef = 0x0BDF;
} // namespace query
} // namespace net::minecraft::client::gl
