...
namespace preset {
struct ModDraw {
  CapScope caps{cap::Lighting, cap::Texture2D, cap::DepthTest, cap::Blend, cap::AlphaTest, cap::Fog, cap::CullFace,
                cap::ScissorTest};
};
struct ModLuaDraw {
  CapScope caps{cap::Lighting, cap::Texture2D, cap::DepthTest, cap::Blend, cap::AlphaTest, cap::Fog, cap::CullFace,
...
struct TexturedGuiNoAlphaTest {
  CapScope caps{cap::Blend, cap::Texture2D, cap::AlphaTest};
  TexturedGuiNoAlphaTest() { detail::alphaBlend(false); }
};
struct TextDraw {
...
struct LabelTextureOff {
  ...
  LabelTextureOff() { setCap(cap::Texture2D, false); }
};
struct WorldOverlay {
...
struct FireOverlay {
  CapScope caps{cap::Blend, cap::Texture2D};
  DepthMaskScope depth;
  FireOverlay() { detail::alphaBlend(false); }
};
struct EntityShadow {
  CapScope caps{cap::Blend, cap::Texture2D};
  DepthMaskScope depth;
...
struct HudFadeText {
  ...
  HudFadeText() { detail::alphaBlend(false); }
};
struct HudChatBackground {
  CapScope caps{cap::Texture2D};
  HudChatBackground() { setCap(cap::Texture2D, false); }
};
...
struct GuiItemRescale {
  ...
  GuiItemRescale() { setCap(cap::RescaleNormal, true); }
};
struct GuiItemCull {
  CapScope caps{cap::CullFace};
  GuiItemCull() { setCap(cap::CullFace, true); }
};
struct GuiItemLabel {
  CapScope caps{cap::Lighting, cap::DepthTest};
  GuiItemLabel() {
...
struct BlockOverlay {
  ...
  BlockOverlay() { setCap(cap::AlphaTest, false); }
};
struct SkyDomeDraw {
...
struct SkyDomeStarsPass {
  CapScope caps{cap::Texture2D};
  SkyDomeStarsPass() { setCap(cap::Texture2D, false); }
};
...
struct SkyDomeSunMoon {
  CapScope caps{cap::Texture2D};
  SkyDomeSunMoon() { setCap(cap::Texture2D, true); }
};
struct AchievementMap {
  CapScope caps{cap::Texture2D, cap::Lighting, cap::RescaleNormal, cap::ColorMaterial, cap::DepthTest, cap::Blend,
                cap::CullFace};
  DepthFuncScope depthFuncScope;
  AchievementMap() {
...
struct FogOff {
  ...
  FogOff() { setCap(cap::Fog, false); }
};
struct FogOn {
  CapScope caps{cap::Fog};
  FogOn() { setCap(cap::Fog, true); }
};
...
struct ListRowHighlight {
  CapScope caps{cap::Texture2D};
  ListRowHighlight() { setCap(cap::Texture2D, false); }
};
struct EntityPassThrough {
  CapScope caps{cap::CullFace, cap::Blend, cap::Texture2D};
  EntityPassThrough() { setCap(cap::CullFace, false); }
};
...
struct BlockOutline {
  CapScope caps{cap::Blend, cap::Texture2D};
  DepthMaskScope depth;
  BlockOutline() { detail::alphaBlend(false); }
};
struct CloudDraw {
...
struct ToastDraw {
  CapScope caps{cap::DepthTest, cap::Fog, cap::CullFace, cap::Texture2D, cap::Lighting, cap::RescaleNormal,
                cap::ColorMaterial};
  DepthMaskScope depth;
  ToastDraw() {
    setCap(cap::DepthTest, false);
...
struct TerrainTextureBind {
  CapScope caps{cap::Texture2D};
  TerrainTextureBind() { setCap(cap::Texture2D, true); }
};
struct HeldItemUnderwater {
  CapScope caps{cap::Blend};
  HeldItemUnderwater() { detail::alphaBlend(false); }
};
...
struct ProgressBarDraw {
  CapScope caps{cap::Texture2D};
  ProgressBarDraw() { setCap(cap::Texture2D, true); }
};
struct ProgressBarSolid {
  CapScope caps{cap::Texture2D};
  ProgressBarSolid() { setCap(cap::Texture2D, false); }
};
...
struct SpiderEyes {
  CapScope caps{cap::Blend};
  SpiderEyes() { detail::alphaBlend(false); }
};
struct FishingLine {
  CapScope caps{cap::Texture2D};
  FishingLine() { setCap(cap::Texture2D, false); }
};
struct EntityBindTexture {
  CapScope caps{cap::Texture2D};
  EntityBindTexture() { setCap(cap::Texture2D, true); }
};
struct ChunkTranslucentDraw {
  CapScope caps{cap::Blend, cap::Texture2D};
  ChunkTranslucentDraw() { detail::alphaBlend(false); }
};
struct OutlineTextureOff {
  CapScope caps{cap::Texture2D};
  OutlineTextureOff() { setCap(cap::Texture2D, false); }
};
struct DebugChart {
...
struct ScreenFogOff {
  CapScope caps{cap::Fog};
  ScreenFogOff() { setCap(cap::Fog, false); }
};
struct GuiTextureOn {
  CapScope caps{cap::Texture2D};
  GuiTextureOn() { setCap(cap::Texture2D, true); }
};
} // namespace preset
} // namespace net::minecraft::client::gl
