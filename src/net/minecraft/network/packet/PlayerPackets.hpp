...
public:
    ...
    void read(std::istream& input) override { health = packetio::readI16BE(input); }
    void write(std::ostream& output) const override { packetio::writeI16BE(output, static_cast<std::int16_t>(health)); }
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onHealthUpdate(*this); }
...
public:
    ...
    void read(std::istream& input) override { onGround = packetio::readU8(input) != 0; }
    void write(std::ostream& output) const override { packetio::writeU8(output, onGround ? 1U : 0U); }
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onPlayerMove(*this); }
    [[nodiscard]] std::size_t size() const override { return 1; }
};

class PlayerMovePositionAndOnGroundPacket : public PlayerMovePacket {
public:
    PlayerMovePositionAndOnGroundPacket() { changePosition = true; }
    ...
    [[nodiscard]] std::size_t size() const override { return 33; }
};

class PlayerMoveLookAndOnGroundPacket : public PlayerMovePacket {
public:
    PlayerMoveLookAndOnGroundPacket() { changeLook = true; }
...
public:
    ...
    [[nodiscard]] std::size_t size() const override { return 41; }
};
...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.handlePlayerAction(*this); }
...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onPlayerInteractBlock(*this); }
    [[nodiscard]] std::size_t size() const override { return 15; }
};
...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.handleInteractEntity(*this); }
    [[nodiscard]] std::size_t size() const override { return 9; }
};
...
public:
    ...
    void read(std::istream& input) override { selectedSlot = packetio::readI16BE(input); }
    void write(std::ostream& output) const override { packetio::writeI16BE(output, static_cast<std::int16_t>(selectedSlot)); }
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onUpdateSelectedSlot(*this); }
    [[nodiscard]] std::size_t size() const override { return 2; }
};
...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onPlayerSleepUpdate(*this); }
    [[nodiscard]] std::size_t size() const override { return 14; }
};
...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onPlayerInput(*this); }
    [[nodiscard]] std::size_t size() const override { return 18; }
};
...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.handleClientCommand(*this); }
