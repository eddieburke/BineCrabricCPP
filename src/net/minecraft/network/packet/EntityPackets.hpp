...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onEntityAnimation(*this); }
    [[nodiscard]] std::size_t size() const override { return 5; }
};
...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onPlayerSpawn(*this); }
    [[nodiscard]] std::size_t size() const override { return 28; }
};
...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onItemEntitySpawn(*this); }
    [[nodiscard]] std::size_t size() const override { return 24; }
};
...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onItemPickupAnimation(*this); }
...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onEntitySpawn(*this); }
    [[nodiscard]] std::size_t size() const override { return static_cast<std::size_t>(21 + (entityData > 0 ? 6 : 0)); }
};
...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onLivingEntitySpawn(*this); }
    [[nodiscard]] std::size_t size() const override { return 20; }
};
...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onPaintingEntitySpawn(*this); }
    [[nodiscard]] std::size_t size() const override { return 24; }
};
...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onEntityVelocityUpdate(*this); }
    [[nodiscard]] std::size_t size() const override { return 10; }
};
...
public:
    ...
    void read(std::istream& input) override { id = packetio::readI32BE(input); }
    void write(std::ostream& output) const override { packetio::writeI32BE(output, id); }
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onEntityDestroy(*this); }
    [[nodiscard]] std::size_t size() const override { return 4; }
};
...
public:
    ...
    void read(std::istream& input) override { id = packetio::readI32BE(input); }
    void write(std::ostream& output) const override { packetio::writeI32BE(output, id); }
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onEntity(*this); }
    [[nodiscard]] std::size_t size() const override { return 4; }
};
...
public:
    ...
    [[nodiscard]] std::size_t size() const override { return 7; }
};

class EntityRotateS2CPacket : public EntityS2CPacket {
public:
    EntityRotateS2CPacket() { rotate = true; }
    ...
    [[nodiscard]] std::size_t size() const override { return 6; }
};

class EntityRotateAndMoveRelativeS2CPacket : public EntityS2CPacket {
public:
    EntityRotateAndMoveRelativeS2CPacket() { rotate = true; }
    ...
    [[nodiscard]] std::size_t size() const override { return 9; }
};
...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onEntityPosition(*this); }
    [[nodiscard]] std::size_t size() const override { return 34; }
};
...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onEntityStatus(*this); }
    [[nodiscard]] std::size_t size() const override { return 5; }
};
...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onEntityVehicleSet(*this); }
    [[nodiscard]] std::size_t size() const override { return 8; }
};
...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onEntityTrackerUpdate(*this); }
    [[nodiscard]] std::size_t size() const override { return 5; }
};
...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onEntityEquipmentUpdate(*this); }
    [[nodiscard]] std::size_t size() const override { return 8; }
};
