...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onOpenScreen(*this); }
    [[nodiscard]] std::size_t size() const override { return 3U + name.size(); }
};
...
public:
    ...
    void read(std::istream& input) override { syncId = packetio::readU8(input); }
    void write(std::ostream& output) const override { packetio::writeU8(output, static_cast<std::uint8_t>(syncId)); }
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onCloseScreen(*this); }
...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onClickSlot(*this); }
...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onScreenHandlerSlotUpdate(*this); }
...
public:
    ...
    void read(std::istream& input) override
    {
        ...
        for (int i = 0; i < count; ++i) {
            ...
            contents[static_cast<std::size_t>(i)] = ItemStack(itemId, packetio::readI8(input), packetio::readI16BE(input));
        }
    }
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onInventory(*this); }
    [[nodiscard]] std::size_t size() const override { return 3U + contents.size() * 5U; }
};
...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onScreenHandlerPropertyUpdate(*this); }
...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onScreenHandlerAcknowledgement(*this); }
...
public:
    ...
    UpdateSignPacket() { worldPacket = true; }
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.handleUpdateSign(*this); }
...
public:
    ...
    MapUpdateS2CPacket() { worldPacket = true; }
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onMapUpdate(*this); }
    [[nodiscard]] std::size_t size() const override { return 4U + updateData.size(); }
};
...
public:
    ...
    void apply(NetworkHandler& networkHandler) const override { networkHandler.onIncreaseStat(*this); }
