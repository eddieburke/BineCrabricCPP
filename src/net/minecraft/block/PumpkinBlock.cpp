...
PumpkinBlock::PumpkinBlock(int blockId, int textureId, bool litIn) : Block(blockId, textureId, material::Material::PUMPKIN)
{
    lit = litIn;
...
void PumpkinBlock::onPlaced(
    World* world, int x, int y, int z, net::minecraft::entity::player::PlayerEntity* placer)
{
