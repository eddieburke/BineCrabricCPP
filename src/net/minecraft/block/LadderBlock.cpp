...
std::optional<net::minecraft::Box> LadderBlock::collisionShapeForMeta(int meta, int x, int y, int z) {
  ...
  case 2:
    return net::minecraft::Box{
        static_cast<double>(x), static_cast<double>(y), static_cast<double>(z + 1) - thickness,
        static_cast<double>(x + 1), static_cast<double>(y + 1), static_cast<double>(z + 1)};
  case 3:
    return net::minecraft::Box{static_cast<double>(x), static_cast<double>(y),
                               static_cast<double>(z), static_cast<double>(x + 1),
                               static_cast<double>(y + 1), static_cast<double>(z) + thickness};
  case 4:
  ...
  case 5:
    return net::minecraft::Box{static_cast<double>(x), static_cast<double>(y),
                               static_cast<double>(z), static_cast<double>(x) + thickness,
                               static_cast<double>(y + 1), static_cast<double>(z + 1)};
  default:
    return std::nullopt;
  }
}
