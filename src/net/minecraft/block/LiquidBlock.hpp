...
public:
    ...
    [[nodiscard]] int getRenderType() const override { return 4; }
    [[nodiscard]] bool hasCollision(int meta, bool allowLiquids) const override { return allowLiquids && meta == 0; }
    ...
    void applyVelocity(World* world, int x, int y, int z, net::minecraft::Entity* entity, net::minecraft::Vec3d& velocity) override;
