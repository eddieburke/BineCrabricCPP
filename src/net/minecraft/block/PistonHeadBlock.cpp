...
namespace {
void addBoxIfIntersecting(const net::minecraft::Box& query, double minX, double minY, double minZ, double maxX,
                          double maxY, double maxZ, std::vector<net::minecraft::Box>& boxes) {
...
void PistonHeadBlock::addIntersectingBoundingBox(World* world, int x, int y, int z, const net::minecraft::Box& box,
