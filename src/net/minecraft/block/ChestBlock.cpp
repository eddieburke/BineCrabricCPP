...
int ChestBlock::getTextureId(const BlockView* blockView, int x, int y, int z, int side) const
{
    ...
    if (northId == id || southId == id) {
        ...
        int frontSide = 5;
        if ((Block::BLOCKS_OPAQUE[static_cast<std::size_t>(westId)] || Block::BLOCKS_OPAQUE[static_cast<std::size_t>(cornerWestId)])
            && !Block::BLOCKS_OPAQUE[static_cast<std::size_t>(eastId)] && !Block::BLOCKS_OPAQUE[static_cast<std::size_t>(cornerEastId)]) {
            frontSide = 5;
        }
        if ((Block::BLOCKS_OPAQUE[static_cast<std::size_t>(eastId)] || Block::BLOCKS_OPAQUE[static_cast<std::size_t>(cornerEastId)])
            && !Block::BLOCKS_OPAQUE[static_cast<std::size_t>(westId)] && !Block::BLOCKS_OPAQUE[static_cast<std::size_t>(cornerWestId)]) {
            frontSide = 4;
        }
    ...
    if (westId == id || eastId == id) {
        ...
        int frontSide = 3;
        if ((Block::BLOCKS_OPAQUE[static_cast<std::size_t>(northId)] || Block::BLOCKS_OPAQUE[static_cast<std::size_t>(cornerNorthId)])
            && !Block::BLOCKS_OPAQUE[static_cast<std::size_t>(southId)] && !Block::BLOCKS_OPAQUE[static_cast<std::size_t>(cornerSouthId)]) {
            frontSide = 3;
        }
        if ((Block::BLOCKS_OPAQUE[static_cast<std::size_t>(southId)] || Block::BLOCKS_OPAQUE[static_cast<std::size_t>(cornerSouthId)])
            && !Block::BLOCKS_OPAQUE[static_cast<std::size_t>(northId)] && !Block::BLOCKS_OPAQUE[static_cast<std::size_t>(cornerNorthId)]) {
            frontSide = 2;
        }
        return (side == frontSide ? textureId + 16 : textureId + 32) + offset;
    }
    int frontSide = 3;
    if (Block::BLOCKS_OPAQUE[static_cast<std::size_t>(northId)] && !Block::BLOCKS_OPAQUE[static_cast<std::size_t>(southId)]) {
        frontSide = 3;
    }
    if (Block::BLOCKS_OPAQUE[static_cast<std::size_t>(southId)] && !Block::BLOCKS_OPAQUE[static_cast<std::size_t>(northId)]) {
        frontSide = 2;
    }
    if (Block::BLOCKS_OPAQUE[static_cast<std::size_t>(westId)] && !Block::BLOCKS_OPAQUE[static_cast<std::size_t>(eastId)]) {
        frontSide = 5;
    }
    if (Block::BLOCKS_OPAQUE[static_cast<std::size_t>(eastId)] && !Block::BLOCKS_OPAQUE[static_cast<std::size_t>(westId)]) {
        frontSide = 4;
    }
