...
PressurePlateBlock::PressurePlateBlock(int blockId,
                                       int textureId,
                                       PressurePlateActivationRule activationRuleIn,
                                       Material& material)
...
void PressurePlateBlock::updatePlateState(World* world, int x, int y, int z) {
 ...
 const net::minecraft::Box box(static_cast<double>(x) + inset,
...
void PressurePlateBlock::registerClass() {
 ...
 Block::STONE_PRESSURE_PLATE =
     (new PressurePlateBlock(
          70, Block::BLOCKS[1]->textureId, PressurePlateActivationRule::MOBS, mat::Material::STONE))
         ->setHardness(0.5f)
         ->setTranslationKey("pressurePlate")
         ->ignoreMetaUpdates();
 Block::WOODEN_PRESSURE_PLATE =
     (new PressurePlateBlock(
          kBlockId, Block::BLOCKS[5]->textureId, PressurePlateActivationRule::EVERYTHING, mat::Material::WOOD))
         ->setHardness(0.5f)
