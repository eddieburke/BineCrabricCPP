...
std::unique_ptr<entity::BlockEntity>
PistonExtensionBlock::createPistonBlockEntity(int blockId, int blockMeta, int facing, bool extending, bool source) {
...
std::optional<net::minecraft::Box> PistonExtensionBlock::getPushedBlockCollisionShape(World* world, int x, int y, int z,
