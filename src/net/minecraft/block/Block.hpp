...
public:
  ...
  [[nodiscard]] static int textureForSide(int side, int sides, int bottom = -1, int top = -1, int frontSide = -1,
                                          int front = -1);
  ...
  [[nodiscard]] virtual bool isEmittingRedstonePowerInDirection(const net::minecraft::BlockView* /*blockView*/,
                                                                int /*x*/, int /*y*/, int /*z*/,
                                                                int /*direction*/) const {
    return false;
  }
  [[nodiscard]] virtual bool canTransferPowerInDirection(net::minecraft::World* /*world*/, int /*x*/, int /*y*/,
                                                         int /*z*/, int /*direction*/) const {
    return false;
  }
  ...
  [[nodiscard]] virtual std::optional<net::minecraft::Box> getCollisionShape(net::minecraft::World* world, int x,
                                                                             int y, int z) const;
  virtual void addIntersectingBoundingBox(net::minecraft::World* world, int x, int y, int z,
  ...
  virtual void randomDisplayTick(net::minecraft::World* /*world*/, int /*x*/, int /*y*/, int /*z*/,
                                 net::minecraft::JavaRandom& /*random*/) {
  }
  ...
  virtual bool onUse(net::minecraft::World* /*world*/, int /*x*/, int /*y*/, int /*z*/,
                     net::minecraft::PlayerEntity* /*player*/) {
    return false;
  }
  virtual void onSteppedOn(net::minecraft::World* /*world*/, int /*x*/, int /*y*/, int /*z*/,
                           net::minecraft::Entity* /*entity*/) {
  }
  virtual void onEntityCollision(net::minecraft::World* /*world*/, int /*x*/, int /*y*/, int /*z*/,
                                 net::minecraft::Entity* /*entity*/) {
  }
  virtual void onBlockBreakStart(net::minecraft::World* /*world*/, int /*x*/, int /*y*/, int /*z*/,
                                 net::minecraft::PlayerEntity* /*player*/) {
  }
  virtual void applyVelocity(net::minecraft::World* /*world*/, int /*x*/, int /*y*/, int /*z*/,
                             net::minecraft::Entity* /*entity*/, net::minecraft::Vec3d& /*velocity*/) {
  }
  virtual void afterBreak(net::minecraft::World* world, net::minecraft::PlayerEntity* player, int x, int y, int z,
                          int meta);
  virtual void onDestroyedByExplosion(net::minecraft::World* /*world*/, int /*x*/, int /*y*/, int /*z*/) {}
  virtual void onBlockAction(net::minecraft::World* /*world*/, int /*x*/, int /*y*/, int /*z*/, int /*data1*/,
                             int /*data2*/) {
  }
  ...
  [[nodiscard]] virtual std::optional<net::minecraft::HitResult> raycast(net::minecraft::World* world, int x, int y,
                                                                         int z, net::minecraft::Vec3d startPos,
                                                                         net::minecraft::Vec3d endPos) const;
  [[nodiscard]] static std::optional<net::minecraft::HitResult>
  raycastLocalBounds(double localMinX, double localMinY, double localMinZ, double localMaxX, double localMaxY,
                     double localMaxZ, int x, int y, int z, net::minecraft::Vec3d startPos,
