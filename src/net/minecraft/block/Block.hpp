...
//
// Static registries mirror Java's parallel arrays. A compatibility BlockRegistry
// view (bottom of file) keeps existing data-table consumers compiling until they
// are migrated to Block::BLOCKS[id]->virtual().
...
public:
    ...
    // registerVanillaBlocks() has run (see BlocksRegistration.cpp).
    static Block* STONE;
    ...
    Block* setSoundGroup(net::minecraft::BlockSoundGroup* group) { soundGroup = group; return this; }
    ...
    [[nodiscard]] float getResistance() const { return resistance_; }
    [[nodiscard]] virtual bool isOpaque() const { return true; }
    [[nodiscard]] virtual bool hasCollision() const { return true; }
    [[nodiscard]] virtual bool hasCollision(int /*meta*/, bool /*allowLiquids*/) const { return hasCollision(); }
    [[nodiscard]] virtual int getTexture(int /*side*/) const { return textureId; }
    [[nodiscard]] virtual int getTexture(int side, int /*meta*/) const { return getTexture(side); }
    [[nodiscard]] virtual int getTickRate() const { return 10; }
    [[nodiscard]] virtual int getDroppedItemCount(net::minecraft::JavaRandom& /*random*/) const { return 1; }
    [[nodiscard]] virtual int getDroppedItemId(int /*blockMeta*/, net::minecraft::JavaRandom& /*random*/) const { return id; }
    [[nodiscard]] virtual int getRenderLayer() const { return 0; }
    [[nodiscard]] virtual int getColor(int /*meta*/) const { return 0xFFFFFF; }
    [[nodiscard]] virtual bool canEmitRedstonePower() const { return false; }
    ...
    [[nodiscard]] bool isTrackingStatistics() const { return shouldTrackStatistics_; }
    [[nodiscard]] virtual int getPistonBehavior() const { return material.getPistonBehavior(); }
    ...
    [[nodiscard]] virtual std::optional<net::minecraft::Box> getCollisionShape(net::minecraft::World* world, int x, int y, int z) const;
    virtual void addIntersectingBoundingBox(net::minecraft::World* world, int x, int y, int z, const net::minecraft::Box& box, std::vector<Box>& boxes) const;
    ...
    virtual void onPlaced(net::minecraft::World* /*world*/, int /*x*/, int /*y*/, int /*z*/, net::minecraft::PlayerEntity* /*player*/) {}
    virtual void onBreak(net::minecraft::World* /*world*/, int /*x*/, int /*y*/, int /*z*/) {}
    virtual bool onUse(net::minecraft::World* /*world*/, int /*x*/, int /*y*/, int /*z*/, net::minecraft::PlayerEntity* /*player*/) { return false; }
    virtual void onSteppedOn(net::minecraft::World* /*world*/, int /*x*/, int /*y*/, int /*z*/, net::minecraft::Entity* /*entity*/) {}
    virtual void onEntityCollision(net::minecraft::World* /*world*/, int /*x*/, int /*y*/, int /*z*/, net::minecraft::Entity* /*entity*/) {}
    virtual void onBlockBreakStart(net::minecraft::World* /*world*/, int /*x*/, int /*y*/, int /*z*/, net::minecraft::PlayerEntity* /*player*/) {}
    virtual void applyVelocity(net::minecraft::World* /*world*/, int /*x*/, int /*y*/, int /*z*/, net::minecraft::Entity* /*entity*/, net::minecraft::Vec3d& /*velocity*/) {}
    virtual void afterBreak(net::minecraft::World* world, net::minecraft::PlayerEntity* player, int x, int y, int z, int meta);
    virtual void onDestroyedByExplosion(net::minecraft::World* /*world*/, int /*x*/, int /*y*/, int /*z*/) {}
    virtual void onBlockAction(net::minecraft::World* /*world*/, int /*x*/, int /*y*/, int /*z*/, int /*data1*/, int /*data2*/) {}
    virtual void onLightChanged(net::minecraft::World* /*world*/, int /*x*/, int /*y*/, int /*z*/) {}
    [[nodiscard]] virtual bool canGrow(net::minecraft::World* /*world*/, int /*x*/, int /*y*/, int /*z*/) const { return true; }
    ...
    [[nodiscard]] virtual std::optional<net::minecraft::HitResult> raycast(net::minecraft::World* world, int x, int y, int z, net::minecraft::Vec3d startPos, net::minecraft::Vec3d endPos) const;
    [[nodiscard]] static std::optional<net::minecraft::HitResult> raycastLocalBounds(
        double localMinX,
        double localMinY,
        double localMinZ,
        double localMaxX,
...
protected:
    [[nodiscard]] virtual int getDroppedItemMeta(int /*blockMeta*/) const { return 0; }
