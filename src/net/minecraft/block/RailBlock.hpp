...
public:
    ...
    [[nodiscard]] bool isAlwaysStraight() const { return alwaysStraight; }
    ...
    [[nodiscard]] int getRenderType() const override { return 9; }
    [[nodiscard]] int getDroppedItemCount(JavaRandom& /*random*/) const override { return 1; }
    [[nodiscard]] int getPistonBehavior() const { return 0; }
