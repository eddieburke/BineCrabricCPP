...
client::gui::widget::ActionButtonWidget& ScreenUiContext::addCenteredButton(int y, std::string text,
                                                                            std::function<void()> onClick) const {
  return screen->addCenteredActionButton(y, std::move(text), std::move(onClick));
}
client::gui::widget::ActionButtonWidget& ScreenUiContext::addButton(int x, int y, int width, int height,
                                                                    std::string text,
                                                                    std::function<void()> onClick) const {
