...
__attribute__((weak)) bool drawLuaItemModel(client::render::Tessellator& /*tessellator*/,
                                            const ItemStack& /*stack*/,
                                            float /*brightness*/) {
    return false;
}

__attribute__((weak)) bool emitManualItemModelQuad(const ManualBlockVertex* /*vertices*/,
                                                   int /*textureId*/,
                                                   float /*red*/,
                                                   float /*green*/,
                                                   float /*blue*/,
