...
bool LuaApi::ready() const {
 return newstate != nullptr && openlibs != nullptr && close != nullptr && loadfilex != nullptr &&
        ...
        settop != nullptr && type != nullptr && tolstring != nullptr && tonumberx != nullptr &&
        tointegerx != nullptr && toboolean != nullptr && touserdata != nullptr && pushnil != nullptr &&
        pushboolean != nullptr && pushnumber != nullptr && pushinteger != nullptr && pushstring != nullptr &&
        pushlstring != nullptr && pushlightuserdata != nullptr && pushvalue != nullptr && pushcclosure != nullptr &&
        createtable != nullptr && setfield != nullptr && getfield != nullptr && getglobal != nullptr &&
        setglobal != nullptr && ref != nullptr && unref != nullptr && rawgeti != nullptr && rawseti != nullptr &&
        next != nullptr && settable != nullptr && rawlen != nullptr;
}
LuaApi gLuaApi;
...
void loadLuaApi() {
 ...
 bindLuaSymbol(api.module, "lua_getglobal", api.getglobal);
